...
cristianoStageIterate_results %>%
  ...
  # rotate_x_text(90) + 
  scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Supplementary_Figures/cristiano_per_stage_vs_healthy_full_WIS_fungi_TopX_13Nov21.svg", 
       dpi = "retina", width = 7, height = 4.5, units = "in")
...
cristianoStageIterate_results %>%
  ...
  # rotate_x_text(90) + 
  scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Other_Figures/cristiano_per_stage_fungi_decontam_only_13Nov21.svg", 
...
cristianoStageIterate_results %>%
  ...
  # rotate_x_text(90) + 
  scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Other_Figures/cristiano_per_stage_fungi_decontam_TopX_13Nov21.svg", 
...
cristianoStageIterate_results %>%
  ...
  stat_pvalue_manual(roc.stat.test, 
                     ...
                     y.position = 1.1)
ggsave(filename = "Figures/Supplementary_Figures/hopkins_auroc_across_stages_16Nov21.svg",
...
cristianoStageIterate_results %>%
  ...
  stat_pvalue_manual(pr.stat.test, 
                     ...
                     label = "ANOVA padj = {p.adj}",
                     y.position = 1.1)
ggsave(filename = "Figures/Supplementary_Figures/hopkins_aupr_across_stages_16Nov21.svg",
       dpi = "retina", units = "in", width = 6.5, height = 5)
#---------------------------------------------------------------------------------------------------------------------------#
...
save(stage_mlFullDB_CV,
     ...
     plots_stage_mlFullDB_CV,
     plots_stage_mlFungiBacteriaWISIntersect_CV,
     plots_stage_mlFungiDecontam_CV,
     file = "Interim_data/cristiano_stageI_CV10_overlay_data_and_plots_4Apr22.RData")

# Combine ROC curves
rocCombinedStage <- plots_stage_mlFungiBacteriaWISIntersect_CV$rocPlot
for(ii in 1:10){
  rocCombinedStage <- rocCombinedStage + 
    geom_path(data = plots_stage_mlFullDB_CV$rocCurveData[[ii]],aes(x=fpr,y=tpr), color = "darksalmon", size = 0.25) +
    geom_path(data = plots_stage_mlFungiDecontam_CV$rocCurveData[[ii]],aes(x=fpr,y=tpr), color = "orange", size = 0.25)
}
rocCombinedStageAll <- rocCombinedStage +
  geom_ribbon(data = plots_stage_mlFullDB_CV$interpROCYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "red", alpha = 0.3, inherit.aes = F) +
  geom_path(data = plots_stage_mlFullDB_CV$interpROCYDf_CI, aes(x = xval, y = Estimate), color = "#BC3C29FF", size = 0.5) +
  geom_ribbon(data = plots_stage_mlFungiDecontam_CV$interpROCYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "orange", alpha = 0.3, inherit.aes = F) + theme_bw() +
  geom_path(data = plots_stage_mlFungiDecontam_CV$interpROCYDf_CI, aes(x = xval, y = Estimate), color = "#E18727FF", size = 0.5) +
  annotate("segment", x = 0.35, xend = 0.45, y = 0.2, yend = 0.2, color = "#BC3C29FF") +
  annotate("text", x = 0.47, y = 0.2, color = "#BC3C29FF", label = paste0("AUROC 99% CI: [", 
...
for(ii in 1:10){
  prCombinedStage <- prCombinedStage + 
    geom_path(data = plots_stage_mlFullDB_CV$prCurveData[[ii]],aes(x=recall,y=precision), color = "darksalmon", size = 0.25) +
    geom_path(data = plots_stage_mlFungiDecontam_CV$prCurveData[[ii]],aes(x=recall,y=precision), color = "orange", size = 0.25)
}
prCombinedStageAll <- prCombinedStage +
  geom_ribbon(data = plots_stage_mlFullDB_CV$interpPRYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "red", alpha = 0.3, inherit.aes = F) +
  geom_path(data = plots_stage_mlFullDB_CV$interpPRYDf_CI, aes(x = xval, y = Estimate), color = "#BC3C29FF", size = 0.5) +
  geom_ribbon(data = plots_stage_mlFungiDecontam_CV$interpPRYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "orange", alpha = 0.3, inherit.aes = F) + theme_bw() +
  geom_path(data = plots_stage_mlFungiDecontam_CV$interpPRYDf_CI, aes(x = xval, y = Estimate), color = "#E18727FF", size = 0.5) +
  annotate("segment", x = 0.15, xend = 0.25, y = 0.2, yend = 0.2, color = "#BC3C29FF") +
  annotate("text", x = 0.27, y = 0.2, color = "#BC3C29FF", label = paste0("AUPR 99% CI: [", 
...
ggsave(filename = "Figures/Main_Figures/roc_pr_CV_overlay_cristiano_stageI_vs_healthy_full_WIS_fungionly.svg",
       units = "in", width = 10, height = 5)
...
save(cristianoTaxaLevel_results,
     file = "Interim_data/cristianoTaxaLevel_results_4Apr22.RData")
## All data types
source("Supporting_scripts/S00-SummarySE.R")
cristianoTaxaLevel_results %>%
  ...
  # rotate_x_text(90) + 
  scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Other_Figures/cristiano_per_taxa_level_bacteria_and_fungi_4Apr22.svg", 
...
cristianoTaxaLevel_results %>%
  ...
  # rotate_x_text(90) + 
  scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Supplementary_Figures/cristiano_per_taxa_level_bacteria_and_fungi_4Apr22.svg", 
...
ggsave(filename = paste0("Figures/Supplementary_Figures/controls_hopkins_auroc_aupr_4Apr22.svg"),
