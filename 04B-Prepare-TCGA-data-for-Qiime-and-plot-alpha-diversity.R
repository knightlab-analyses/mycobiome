...
load("Interim_data/snmDataFungi_DecontamV2_13Oct21.RData") # To load the metadata and raw data objects
...
alphaDivOtus_HMS_colored %>%
  ...
  stat_n_text()
ggsave(filename = "Figures/Figure_3/alphaDivOtusPlot_HMS.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivOtus_HMS_colored %>% write.csv("Figures_data/Figure_3/alphaDivOtusPlot_HMS.csv")
...
alphaDivShannon_HMS_colored %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Figure_3/alphaDivShannonPlot_HMS.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivShannon_HMS_colored %>% write.csv("Figures_data/Figure_3/alphaDivOtusPlot_HMS.csv")
...
alphaDivOtus_MDA_colored %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Figure_3/alphaDivOtusPlot_MDA.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivOtus_MDA_colored %>% write.csv("Figures_data/Figure_3/alphaDivOtusPlot_MDA.csv")
...
alphaDivShannon_MDA_colored %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Figure_3/alphaDivShannonPlot_MDA.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivShannon_MDA_colored %>% write.csv("Figures_data/Figure_3/alphaDivShannonPlot_MDA.csv")
...
alphaDivOtus_BCM %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Supplementary_Figures/alphaDivOtusPlot_BCM.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivShannon_BCM %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Supplementary_Figures/alphaDivShannonPlot_BCM.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivOtus_WashU %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Supplementary_Figures/alphaDivOtusPlot_WashU.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivShannon_WashU %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Supplementary_Figures/alphaDivShannonPlot_WashU.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivOtus_Broad_WGS %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Supplementary_Figures/alphaDivOtusPlot_Broad_WGS.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivShannon_Broad_WGS %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text()
ggsave(filename = "Figures/Supplementary_Figures/alphaDivShannonPlot_Broad_WGS.svg",
         dpi = "retina", units = "in", height = 4, width = 7)
