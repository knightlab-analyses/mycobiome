...
load("Interim_data/summarized_weizmann_data_various_taxa_levels_15Sep21.RData")
...
weizmannPhylumShared$diversity <- rowSums(weizmannPhylumShared>0)
weizmannClassShared$diversity <- rowSums(weizmannClassShared>0)
weizmannOrderShared$diversity <- rowSums(weizmannOrderShared>0)
weizmannFamilyShared$diversity <- rowSums(weizmannFamilyShared>0)
weizmannGenusShared$diversity <- rowSums(weizmannGenusShared>0)
weizmannSpeciesShared$diversity <- rowSums(weizmannSpeciesShared>0)
...
save(weizmannPhylum,
     ...
     file = "Interim_data/data_for_ml_weizmann_15Sep21.RData")
# Use "Interim_data/data_for_ml_weizmann_15Sep21.RData" to run
# "Supporting_scripts/S11-ML-fungi-10k-rep1-weizmann.R"
# Which was run on a Slurm compute cluster using the submission script
# "Supporting_scripts/S11-Submit-job.sh"
...
wzMLres <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_weizmann_with_and_without_shared_feat_ALL.csv")
