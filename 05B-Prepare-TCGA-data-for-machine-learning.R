...
save(rep200_HiSeq_Fungi_DecontamV2_HMS,
     ...
     file = "Interim_data/data_for_ml_tcga_by_seq_center_and_experimental_strategy_with_coverage_filter_decontamV2_14Oct21.RData")
...
save(df_psRep200_HiSeq_Fungi_DecontamV2_HMS_phylum,
     ...
     file = "Interim_data/data_for_ml_tcga_by_seq_center_and_experimental_strategy_taxa_levels_and_wz_intersect_decontamV2_14Oct21.RData")
...
save(metaQiitaCombined_Nonzero_DecontamV2,
     ...
     file = "Interim_data/data_for_ml_tcga_wgs_vs_rna_decontamV2_14Oct21.RData")
...
save(metaQiitaCombined_Nonzero_DecontamV2,
     ...
     file = "Interim_data/raw_data_tcga_all_cancers_decontamV2_14Oct21.RData")
...
save(metaQiitaCombined_Nonzero_DecontamV2_8cancer,
     ...
     file = "Interim_data/raw_data_tcga_8_cancers_decontamV2_14Oct21.RData")
...
rep200FungiDecontamV2GenusVSNM_Obj_CT <- vsnmFunctionTCGA(rep200FungiDecontamV2Genus, cancerTypeFlag = TRUE) # converges
rep200FungiDecontamV2GenusVSNM_CT <- rep200FungiDecontamV2GenusVSNM_Obj_CT$snmData
rep200FungiDecontamV2SpeciesVSNM_Obj_CT <- vsnmFunctionTCGA(rep200FungiDecontamV2Species, cancerTypeFlag = TRUE) # converges
...
#--------------------------------------------------------------------------------------------------------------------#
# Separate WGS and RNA-Seq data for ML (to compare performance between them after batch correcting)
# Using sample_type only Voom-SNM data
#--------------------------------------------------------------------------------------------------------------------#
...
save(metaQiitaCombined_Nonzero_DecontamV2,
     ...
     file = "Interim_data/data_for_ml_tcga_wgs_vs_rna_sample_type_VSNM_decontamV2_27Nov21.RData")
...
mlPerfAll10k_full_WGS_RNA_v2 <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_full_wgs_rna_vsnm_STonly_ALL_DecontamV2_27Nov21.csv", stringsAsFactors = FALSE)
...
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_wgs_vs_rna_VSNM_STonly_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_full_WGS_RNA_v2 %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_STN_wgs_vs_rna_VSNM_STonly_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.9, label.y = 0.05,
               ...
               parse = TRUE)
ggsave(filename = "Figures/Supplementary_Figures/regr_auroc_tcga_wgs_vs_full_PT_VSNM_STonly.svg",
...
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.9, label.y = 0.05,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE)
ggsave(filename = "Figures/Supplementary_Figures/regr_aupr_tcga_wgs_vs_full_PT_VSNM_STonly.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
# RNA vs. Full | AUROC
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.7, label.y = 0.05,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE)
ggsave(filename = "Figures/Supplementary_Figures/regr_auroc_tcga_rna_vs_full_PT_VSNM_STonly.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
# RNA vs. Full | AUPR
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.05, label.y = 0.9,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE)
ggsave(filename = "Figures/Supplementary_Figures/regr_aupr_tcga_rna_vs_full_PT_VSNM_STonly.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
...
save(metaQiitaCombined_Nonzero_DecontamV2,
     ...
     file = "Interim_data/data_for_ml_tcga_vsnm_topX_17Nov21.RData")
...
save(rep200_HiSeq_Fungi_DecontamV2_TopX_HMS,
     ...
     metaQiitaCombined_Nonzero_DecontamV2_Broad_RNA,
     file = "Interim_data/data_for_ml_tcga_raw_topX_per_seq_center_17Nov21.RData")
...
rep200FungiDecontamV2Genus_8cancer_VSNM_CT_WGS <- rep200FungiDecontamV2Genus_8cancer_VSNM_CT[rownames(metaQiitaCombined_Nonzero_DecontamV2_8cancer_WGS),]
rep200FungiDecontamV2Species_8cancer_VSNM_CT_WGS <- rep200FungiDecontamV2Species_8cancer_VSNM_CT[rownames(metaQiitaCombined_Nonzero_DecontamV2_8cancer_WGS),]
...
rep200FungiDecontamV2Genus_8cancer_VSNM_CT_RNA <- rep200FungiDecontamV2Genus_8cancer_VSNM_CT[rownames(metaQiitaCombined_Nonzero_DecontamV2_8cancer_RNA),]
rep200FungiDecontamV2Species_8cancer_VSNM_CT_RNA <- rep200FungiDecontamV2Species_8cancer_VSNM_CT[rownames(metaQiitaCombined_Nonzero_DecontamV2_8cancer_RNA),]
...
save(metaQiitaCombined_Nonzero_DecontamV2_8cancer_WGS,
     ...
     file = "Interim_data/data_for_ml_8_cancers_wgs_vs_rna_decontamV2_14Oct21.RData")
...
load("Interim_data/data_tcga_8_cancers_features_matched_to_weizmann_14Oct21.RData")
...
save(metaQiitaCombined_Nonzero_DecontamV2_8cancer,
     ...
     rep200FungiDecontamV2Genus_8cancer_VSNM_CT,
     rep200FungiDecontamV2Species_8cancer_VSNM_CT,
     file = "Interim_data/data_for_ml_8_cancers_decontamV2_14Oct21.RData")
...
save(metaQiitaCombined_Nonzero_DecontamV2,
     ...
     rep200FungiDecontamV2SpeciesVSNM,
     rep200FungiDecontamV2GenusVSNM_CT,
     rep200FungiDecontamV2SpeciesVSNM_CT,
     snmDataOGUFungiDecontamV2,
     file = "Interim_data/data_for_ml_tcga_decontamV2_14Oct21.RData")
...
save(rep200FungiFamilyShared_NonzeroVSNM,
     ...
     file = "Interim_data/data_for_ml_tcga_shared_features_decontamV2_14Oct21.RData")
...
save(rep200FungiPhylumShared_8cancer_Nonzero_VSNM,
     ...
     file = "Interim_data/data_for_ml_8_cancers_shared_features_decontamV2_14Oct21.RData")

# Scripts: S10B

save(metaQiitaCombined_Nonzero_DecontamV2_Cov_Nonzero_Filt,
     rep200FungiCovSpeciesVSNM,
     file = "Interim_data/data_for_ml_tcga_high_coverage_03Nov21.RData")

# Scripts: S21

save(metaQiitaCombined_Nonzero_DecontamV2_8cancer_Cov_Nonzero_Filt,
     rep200FungiSpecies_8cancer_Cov_Nonzero_VSNM,
     file = "Interim_data/data_for_ml_tcga_8cancers_high_coverage_03Nov21.RData")
...
mlPerfAll10k_8cancer <- read.csv("Interim_data/rep_perfFungi_10k_rep1_8cancer_higher_taxa_and_intersected_ALL_decontamV2_14Oct21.csv", stringsAsFactors = FALSE)
...
mlPerfAll10k_8cancer$datasetName[mlPerfAll10k_8cancer$datasetName == "rep200FungiDecontamV2Family_8cancer_VSNM_CT"] <- "Family (CT)"
mlPerfAll10k_8cancer$datasetName[mlPerfAll10k_8cancer$datasetName == "rep200FungiDecontamV2Genus_8cancer_VSNM_CT"] <- "Genus (CT)"
mlPerfAll10k_8cancer$datasetName[mlPerfAll10k_8cancer$datasetName == "rep200FungiDecontamV2Species_8cancer_VSNM_CT"] <- "Species (CT)"
...
mlPerfAll10k_8cancer %>%
  ...
  mutate(nullAUPR = ifelse(variable=="AUROC",NA,nullAUPR), nullAUROC = ifelse(variable=="AUPR",NA,nullAUROC)) %>%
  ggplot(aes(reorder(abbrev, value, FUN=median),value, color=datasetName)) +
  geom_errorbar(aes(ifelse(value-ci<0,0,value-ci), ymax=ifelse(value+ci>1,1,value+ci)),width=0.4,size=0.6,position = position_dodge(0.9)) +
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Figure_4/figure_4_D__mlPerfAll10k_rep1_8cancers_PT_order_family_genus_species_decontamV2.svg", dpi = "retina",
       width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer %>%
  filter(sampleType == "Primary Tumor") %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_D__mlPerfAll10k_rep1_8cancers_PT_order_family_genus_species.csv")
...
mlPerfAll10k_8cancer %>%
  ...
  ggplot(aes(reorder(abbrev, value, FUN=median),value, color=datasetName)) +
  geom_errorbar(aes(ifelse(value-ci<0,0,value-ci), ymax=ifelse(value+ci>1,1,value+ci)),width=0.4,size=0.6,position = position_dodge(0.9)) + geom_errorbar(aes(y=nullAUPR,ymin=nullAUPR,ymax=nullAUPR),color="darkgray",lty="dotted") + geom_errorbar(aes(y=nullAUROC,ymin=nullAUROC,ymax=nullAUROC),color="darkgray",lty="dotted") +
  geom_point(position = position_dodge(0.9), size=1.5) + xlab("Cancer type") + ylab("Area Under Curve") + theme_pubr() +
  facet_wrap(~variable) + scale_y_continuous(breaks = seq(0, 1, by = 0.1), limits = c(0,1)) +
  ggtitle("Primary Tumor | 1 Vs All | Order, Family, Genus, Species Levels") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_D__optional_mlPerfAll10k_rep1_8cancers_PT_order_family_genus_species_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer %>%
  filter(sampleType == "Primary Tumor") %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_D__optional_mlPerfAll10k_rep1_8cancers_PT_order_family_genus_species.csv")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_order_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_family_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_genus_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_species_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Figure_4/figure_4_E__mlPerfAll10k_rep1_8cancers_PT_vs_STN_order_family_genus_species_decontamV2.svg", dpi = "retina",
       width = 8, height = 5, units = "in")
# Save underlying data
mlPerfAll10k_8cancer %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_E__mlPerfAll10k_rep1_8cancers_PT_vs_STN_order_family_genus_species.csv")
...
mlPerfAll10k_8cancer %>%
  ...
  ggtitle("Primary Tumor vs. Adjacent Normal | Order, Family, Genus, Species Levels") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_E__optional_mlPerfAll10k_rep1_8cancers_PT_vs_STN_order_family_genus_species_decontamV2.svg", dpi = "retina",
         width = 8, height = 5, units = "in")
# Save underlying data
mlPerfAll10k_8cancer %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_E__optional_mlPerfAll10k_rep1_8cancers_PT_vs_STN_order_family_genus_species.csv")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_STN_order_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_STN_family_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_STN_genus_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_STN_species_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Figure_4/figure_4_F__mlPerfAll10k_rep1_8cancers_BDN_order_family_genus_species_decontamV2.svg", dpi = "retina",
       width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer %>%
  filter(sampleType == "Blood Derived Normal") %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/mlPerfAll10k_rep1_8cancers_BDN_order_family_genus_species.csv")
...
mlPerfAll10k_8cancer %>%
  ...
  ggtitle("Blood Derived Normal | 1 Vs All | Order, Family, Genus, Species Levels") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_F__optional_mlPerfAll10k_rep1_8cancers_BDN_order_family_genus_species_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer %>%
  filter(sampleType == "Blood Derived Normal") %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/optional_mlPerfAll10k_rep1_8cancers_BDN_order_family_genus_species.csv")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_BDN_order_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_BDN_family_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_BDN_genus_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_BDN_species_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
...
mlPerfAll10k_8cancer_WGS_RNA <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_8cancers_wgs_vs_rna_taxa_levels_ALL_decontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_8cancer <- read.csv("Supporting_data/tcga_abbreviations_8cancer.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_8cancer_WGS_RNA$datasetName[mlPerfAll10k_8cancer_WGS_RNA$datasetName == "rep200FungiDecontamV2Genus_8cancer_VSNM_CT_WGS"] <- "Genus WGS (CT)"
mlPerfAll10k_8cancer_WGS_RNA$datasetName[mlPerfAll10k_8cancer_WGS_RNA$datasetName == "rep200FungiDecontamV2Genus_8cancer_VSNM_CT_RNA"] <- "Genus RNA (CT)"
mlPerfAll10k_8cancer_WGS_RNA$datasetName[mlPerfAll10k_8cancer_WGS_RNA$datasetName == "rep200FungiDecontamV2Species_8cancer_VSNM_CT_WGS"] <- "Species WGS (CT)"
mlPerfAll10k_8cancer_WGS_RNA$datasetName[mlPerfAll10k_8cancer_WGS_RNA$datasetName == "rep200FungiDecontamV2Species_8cancer_VSNM_CT_RNA"] <- "Species RNA (CT)"
...
mlPerfAll10k_8cancer_WGS_RNA %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_species_wgs_vs_rna_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_WGS_RNA %>%
  filter(sampleType == "Primary Tumor") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_species_wgs_vs_rna.csv")
...
mlPerfAll10k_8cancer_WGS_RNA %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_NAT_species_wgs_vs_rna_decontamV2.svg", dpi = "retina",
       width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_WGS_RNA %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_NAT_species_wgs_vs_rna_decontamV2.svg")
...
mlPerfAll10k_8cancer_Shared <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_8cancers_shared_features_ALL_decontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_8cancer <- read.csv("Supporting_data/tcga_abbreviations_8cancer.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_8cancer_Shared %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_species_shared_decontamV2.svg", dpi = "retina",
       width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_WGS_RNA %>%
  filter(sampleType == "Primary Tumor") %>%
  filter(grepl("Species",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_species_shared.csv")
...
mlPerfAll10k_8cancer_Shared %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_NAT_phylum_family_genus_species_shared_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_WGS_RNA %>%
  filter(sampleType == "Primary Tumor") %>%
  # filter(grepl("Species",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_PT_vs_NAT_phylum_family_genus_species_shared.csv")
...
mlPerfAll10k_8cancer_Shared %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_BDN_phylum_family_genus_species_shared_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_WGS_RNA %>%
  filter(sampleType == "Blood Derived Normal") %>%
  # filter(grepl("Species",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Supplementary_Figures/mlPerfAll10k_rep1_8cancers_BDN_phylum_family_genus_species_shared.csv")
...
mlPerfAll10k_8cancer_Cov <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_8cancers_high_coverage_ALL_decontamV2_03Nov21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_8cancer <- read.csv("Supporting_data/tcga_abbreviations_8cancer.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_8cancer_Overlay %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Figure_4/figure_4_D__overlay_mlPerfAll10k_rep1_8cancers_PT_species_decontamV2.svg", dpi = "retina",
       width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_Overlay %>%
  filter(sampleType == "Primary Tumor") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_D__overlay_mlPerfAll10k_rep1_8cancers_PT_species.csv")
...
mlPerfAll10k_8cancer_Overlay %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_E__overlay_mlPerfAll10k_rep1_8cancers_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_Overlay %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_E__overlay_mlPerfAll10k_rep1_8cancers_PT_vs_NAT_species.csv")
...
mlPerfAll10k_8cancer_Overlay %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_F__overlay_mlPerfAll10k_rep1_8cancers_BDN_species_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_8cancer_Overlay %>%
  filter(sampleType == "Blood Derived Normal") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_F__overlay_mlPerfAll10k_rep1_8cancers_BDN_species.csv")
...
mlPerfAll10k_Allcancer <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_higher_taxa_and_intersected_ALL_decontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_Allcancer$datasetName[mlPerfAll10k_Allcancer$datasetName == "rep200FungiDecontamV2GenusVSNM_CT"] <- "Genus (CT)"
mlPerfAll10k_Allcancer$datasetName[mlPerfAll10k_Allcancer$datasetName == "rep200FungiDecontamV2SpeciesVSNM_CT"] <- "Species (CT)"
mlPerfAll10k_Allcancer$datasetName[mlPerfAll10k_Allcancer$datasetName == "snmDataOGUFungiDecontamV2"] <- "OGU (CT)"
...
save(mlPerfAll10k_Allcancer, file = "Interim_data/mlPerfAll10k_Allcancer.RData")
...
ptPerfSummarizedMinClassSize %>%
  ...
  stat_cor(method = "pearson", cor.coef.name = "R", show.legend = FALSE, color="red", label.x = 600, label.y = 0.02) + 
  theme_bw() + theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  geom_text_repel() +
  labs(x = "Minority class size (per cancer type)", y = "Average AUPR", title = "Correlating AUPR and minority class size\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_minority_class_size_all_TCGA_PT.svg",
...
ptPerfSummarizedMinClassSize %>%
  ...
  geom_text_repel() +
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Minority class size (per cancer type)", y = "Average AUROC", title = "Correlating AUROC and minority class size\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_minority_class_size_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptPerfSummarizedMinClassSize %>%
  ...
  theme_bw() + theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  geom_text_repel() +
  labs(x = "Ratio of minority to majority class size (per cancer type)", y = "Average AUPR", title = "Correlating AUPR and ratio of minority to majority class size\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_ratio_minority_to_majority_class_size_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptPerfSummarizedMinClassSize %>%
  ...
  geom_text_repel() +
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Ratio of minority to majority class size (per cancer type)", y = "Average AUROC", title = "Correlating AUROC and ratio of minority to majority class size\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_ratio_minority_to_majority_class_size_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptPerfSummarizedReadDepth %>%
  ...
  theme_bw() + theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  geom_text_repel() +
  labs(x = "Average Total Read Depth Per\nCancer Type (Primary Tumor)", y = "Average AUPR", title = "Correlating AUPR and read depth\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_read_depth_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptPerfSummarizedReadDepth %>%
  ...
  geom_text_repel() +
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Average Total Read Depth Per\nCancer Type (Primary Tumor)", y = "Average AUROC", title = "Correlating AUROC and read depth\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_read_depth_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptPerfSummarizedReadDepth %>%
  ...
  theme_bw() + theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  geom_text_repel() +
  labs(x = "Average Unmapped Reads Per\nCancer Type (Primary Tumor)", y = "Average AUPR", title = "Correlating AUPR and unmapped reads\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_unmapped_reads_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptPerfSummarizedReadDepth %>%
  ...
  geom_text_repel() +
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Average Unmapped Reads Per\nCancer Type (Primary Tumor)", y = "Average AUROC", title = "Correlating AUROC and unmapped reads\nfor primary tumor TCGA models") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_unmapped_reads_all_TCGA_PT.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_order_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  summarySE(measurevar = "value", groupvars = c("datasetName","variable","abbrev","minorityClassSize","majorityClassSize","minorityClassName","majorityClassName","nullAUPR","nullAUROC","minorityClassSize","majorityClassSize","nullAUPR","nullAUROC")) %>%
  ggplot(aes(reorder(abbrev, value, FUN=median),value, color=variable)) +
  geom_errorbar(aes(ifelse(value-ci<0,0,value-ci), ymax=ifelse(value+ci>1,1,value+ci)),width=0.4,size=0.6,position = position_dodge(0.9)) + geom_errorbar(aes(y=nullAUPR,ymin=nullAUPR,ymax=nullAUPR),color="#0072B5FF",lty="dotted") + geom_errorbar(aes(y=nullAUROC,ymin=nullAUROC,ymax=nullAUROC),color="#BC3C29FF",lty="dotted") +
  geom_point(position = position_dodge(0.9), size=1.5) + xlab("Cancer type") + ylab("Area Under Curve") + theme_pubr() +
  # facet_wrap(~variable) + 
  scale_y_continuous(breaks = seq(0, 1, by = 0.1), limits = c(0,1)) +
  ggtitle("All of TCGA | Primary Tumor | 1 Vs All | Family") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_family_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_genus_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_species_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_STN_order_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_STN_family_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") +
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_STN_genus_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_STN_species_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_order_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_family_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_genus_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_species_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
save(mlPerfAll10k_Allcancer_Shared, file = "Interim_data/mlPerfAll10k_Allcancer_Shared.RData")
#-------------------------Plot primary tumor 1 vs. all others performance-------------------------#
mlPerfAll10k_Allcancer_Shared %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_species_shared_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer_Shared %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_NAT_species_shared_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_Allcancer_Shared %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_species_shared_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_full_WGS_RNA <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_full_wgs_rna_vsnm_ALL_DecontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_full_WGS_RNA %>%
  ...
  ggtitle("All of TCGA | Primary Tumor | 1 Vs All | Species | WGS vs. RNA") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_wgs_vs_rna_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")
...
mlPerfAll10k_full_WGS_RNA %>%
  ...
  ggtitle("All of TCGA | Primary Tumor vs Solid Tissue Normal | 1 Vs All | Species | WGS vs. RNA") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_STN_wgs_vs_rna_decontamV2.svg", dpi = "retina",
         width = 12, height = 6, units = "in")

#-------------------------Linear regression of WGS-only OR RNA-Seq-only vs. VSNM data-------------------------#
mlPerfAll10k_full_WGS_RNA %>%
  filter(sampleType == "Primary Tumor") %>%
  distinct() %>% droplevels() -> tmp
...
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.9, label.y = 0.05,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE) +
  ggsave(filename = "Figures/Supplementary_Figures/regr_auroc_tcga_wgs_vs_full_PT_VSNM.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
# WGS vs. Full | AUPR
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
       aes(x = avgPR, y =  avgPR_WGS, label = abbrev)) +
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.9, label.y = 0.05,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE) +
  ggsave(filename = "Figures/Supplementary_Figures/regr_aupr_tcga_wgs_vs_full_PT_VSNM.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
# RNA vs. Full | AUROC
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
       aes(x = avgROC, y =  avgROC_RNA, label = abbrev)) +
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.7, label.y = 0.05,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE) +
  ggsave(filename = "Figures/Supplementary_Figures/regr_auroc_tcga_rna_vs_full_PT_VSNM.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
# RNA vs. Full | AUPR
ggplot(perfSummarizedFullvsWGSvsRNA_Full_Joined, 
       aes(x = avgPR, y =  avgPR_RNA, label = abbrev)) +
  ...
  stat_poly_eq(formula = y ~ x, label.x = 0.05, label.y = 0.9,
               aes(label = paste(..eq.label.., sep = "~~~")), 
               parse = TRUE) +
  ggsave(filename = "Figures/Supplementary_Figures/regr_aupr_tcga_rna_vs_full_PT_VSNM.svg",
         dpi = "retina", units = "in", height = 5, width = 5)
...
#--------------------------First load high coverage data--------------------------#
mlPerfAll10k_Allcancer_Cov <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_high_coverage_ALL_decontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
save(mlPerfAll10k_Allcancer_Cov, file = "Interim_data/mlPerfAll10k_Allcancer_Cov.RData")
...
mlPerfAll10k_Allcancer_Overlay %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Figure_4/figure_4_D__alternative_overlay_mlPerfAll10k_rep1_Allcancers_PT_species_decontamV2_alphabetical.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_Overlay %>%
  ...
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_D__alternative_overlay_mlPerfAll10k_rep1_Allcancers_PT_species.csv")
...
mlPerfAll10k_Allcancer_Overlay %>%
  ...
  ggtitle("Primary Tumor vs NAT | Species | Overlay") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_E__alternative_overlay_mlPerfAll10k_rep1_Allcancers_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
         width = 10, height = 6, units = "in")
# Save underlying data
mlPerfAll10k_Allcancer_Overlay %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_E__alternative_overlay_mlPerfAll10k_rep1_Allcancers_PT_vs_NAT_species.csv")
...
mlPerfAll10k_Allcancer_Overlay %>%
  ...
  ggtitle("Blood Derived Normal | 1 Vs All | Species | Overlay") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Figure_4/figure_4_F__alternative_overlay_mlPerfAll10k_rep1_Allcancers_BDN_species_decontamV2_alphabetical.svg", dpi = "retina",
         width = 12, height = 3.5, units = "in")
# Save underlying data
mlPerfAll10k_Allcancer_Overlay %>%
  filter(sampleType == "Blood Derived Normal") %>%
  filter(grepl("Species",datasetName)) %>%
  filter(!grepl("CT",datasetName)) %>%
  distinct() %>% droplevels() %>% write.csv("Figures_data/Figure_4/figure_4_F__alternative_overlay_mlPerfAll10k_rep1_Allcancers_BDN_species_decontamV2.svg")
...
mlPerfAll10k_Allcancer_Raw <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_by_seq_center_ALL_DecontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
save(mlPerfAll10k_Allcancer_Raw,
     file = "Interim_data/mlPerfAll10k_Allcancer_Raw.RData")
#-------------------------Plot primary tumor 1 vs. all others performance-------------------------#
# HMS
mlPerfAll10k_Allcancer_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_species_decontamV2.svg", dpi = "retina",
         width = 6, height = 4, units = "in")
  # MDA
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Primary Tumor") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_PT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # BCM
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Primary Tumor") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # WashU
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Primary Tumor") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_PT_species_decontamV2.svg", dpi = "retina",
  ...
  mlPerfAll10k_Allcancer_Raw %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # UNC
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Primary Tumor") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_species_decontamV2.svg", dpi = "retina",
  ...
  mlPerfAll10k_Allcancer_Raw %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  ...
  mlPerfAll10k_Allcancer_Raw %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  ...
  mlPerfAll10k_Allcancer_Raw %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  ...
  mlPerfAll10k_Allcancer_Raw %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # UNC
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
           width = 8, height = 4, units = "in")
  # CMS
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_vs_NAT_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  ...
  mlPerfAll10k_Allcancer_Raw %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_BDN_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # MDA
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Blood Derived Normal") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_BDN_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # BCM
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Blood Derived Normal") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_BDN_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
  # WashU
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Blood Derived Normal") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_BDN_species_decontamV2.svg", dpi = "retina",
           width = 5, height = 4, units = "in")
  # Broad WGS
  mlPerfAll10k_Allcancer_Raw %>%
    filter(sampleType == "Blood Derived Normal") %>%
    ...
    rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
    ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_BDN_species_decontamV2.svg", dpi = "retina",
           width = 6, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_by_seq_center_taxa_level_and_WIS_intersect_ALL_decontamV2_14Oct21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
## NOTE: Broad_RNA only included GBM tumors, so no ML comparisons were made
# # Broad_RNA - decontam
# mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName[mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName == "df_psRep200_HiSeq_Fungi_DecontamV2_Broad_RNA_phylum"] <- "Broad phylum decontaminated (RNA-Seq)"
# mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName[mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName == "df_psRep200_HiSeq_Fungi_DecontamV2_Broad_RNA_class"] <- "Broad class decontaminated (RNA-Seq)"
# mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName[mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName == "df_psRep200_HiSeq_Fungi_DecontamV2_Broad_RNA_order"] <- "Broad order decontaminated (RNA-Seq)"
# mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName[mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName == "df_psRep200_HiSeq_Fungi_DecontamV2_Broad_RNA_family"] <- "Broad family decontaminated (RNA-Seq)"
# mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName[mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName == "df_psRep200_HiSeq_Fungi_DecontamV2_Broad_RNA_genus"] <- "Broad genus decontaminated (RNA-Seq)"
# mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName[mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann$datasetName == "df_psRep200_HiSeq_Fungi_DecontamV2_Broad_RNA_species"] <- "Broad species decontaminated (RNA-Seq)"
...
save(mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann, 
     file = "Interim_data/mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann.RData")
#-------------------------Plot primary tumor 1 vs. all others performance-------------------------#
# HMS - decontam
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
       width = 8, height = 5, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# BCM - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# MDA - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# WashU - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# Broad_WGS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# CMS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_vs_NAT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# HMS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_vs_NAT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_vs_NAT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# BCM - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_vs_NAT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_vs_NAT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# Broad_WGS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_vs_NAT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_vs_NAT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# UNC - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_vs_NAT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_vs_NAT_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# CMS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_vs_NAT_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_BDN_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# HMS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_BDN_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_BDN_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# BCM - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_BDN_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_BDN_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# MDA - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_BDN_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_BDN_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# WashU - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_BDN_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_BDN_taxa_level_decontam_decontamV2.svg", dpi = "retina",
         width = 10, height = 5, units = "in")
# Broad_WGS - shared
mlPerfAll10k_Allcancer_Raw_Taxa_Levels_and_Weizmann %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_BDN_taxa_level_shared_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  ggtitle("Harvard Medical School (WGS) | Raw Data | Primary Tumor | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_species_overlay_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  ggtitle("Baylor College of Medicine (WGS) | Raw Data | Primary Tumor | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_species_overlay_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  ggtitle("MD Anderson (WGS) | Raw Data | Primary Tumor | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_PT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# WashU - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_PT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 9, height = 4, units = "in")
# Broad_WGS - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  ggtitle("Broad Institute (WGS) | Raw Data | Primary Tumor | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# UNC - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 10, height = 4, units = "in")
# CMS - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 10, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_PT_vs_NAT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# BCM - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_PT_vs_NAT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_PT_vs_NAT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# UNC - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_UNC_PT_vs_NAT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 10, height = 4, units = "in")
# CMS - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  ggtitle("Canada's Michael Smith Genome Sciences Centre (RNA-Seq) | Raw Data\nPrimary Tumor vs Solid Tissue Normal | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_CMS_PT_vs_NAT_species_overlay_decontamV2.svg", dpi = "retina",
         width = 10, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  ggtitle("Harvard Medical School (WGS) | Raw Data | Blood Derived Normal | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_HMS_BDN_species_overlay_decontamV2.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  ...
  ggtitle("Baylor College of Medicine (WGS) | Raw Data | Blood Derived Normal | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_BCM_BDN_species_overlay_decontamV2.svg", dpi = "retina",
         width = 10, height = 4, units = "in")
# MDA - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  ggtitle("MD Anderson (WGS) | Raw Data | Blood Derived Normal | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_MDA_BDN_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# WashU - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_WashU_BDN_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
# Broad_WGS - overlay
mlPerfAll10k_Allcancer_Raw_Overlay_Filt %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  ggtitle("Broad Institute (WGS) | Raw Data | Blood Derived Normal | 1 Vs All | Species") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") + 
  ggsave("Figures/Figure_4/figure_4_XX_mlPerfAll10k_rep1_Broad_WGS_BDN_species_overlay_decontamV2.svg", dpi = "retina",
         width = 8, height = 4, units = "in")
...
ptRawDataPerfSummarizedMinClassSize %>%
  ...
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_minority_class_size_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedMinClassSize %>%
  ...
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Minority class size (per cancer type)", y = "Average AUROC", title = "Correlating AUROC and minority class size\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_minority_class_size_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedMinClassSize %>%
  ...
  geom_text_repel() +
  labs(x = "Ratio of minority to majority class size (per cancer type)", y = "Average AUPR", title = "Correlating AUPR and ratio of minority to majority class size\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_ratio_minority_to_majority_class_size_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedMinClassSize %>%
  ...
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Ratio of minority to majority class size (per cancer type)", y = "Average AUROC", title = "Correlating AUROC and ratio of minority to majority class size\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_ratio_minority_to_majority_class_size_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedReadDepth %>%
  ...
  theme_bw() + theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  geom_text_repel() +
  labs(x = "Average Total Read Depth Per\nSeq Center & Cancer Type (Primary Tumor)", y = "Average AUPR", title = "Correlating AUPR and read depth\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_read_depth_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedReadDepth %>%
  ...
  geom_text_repel() +
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Average Total Read Depth Per\nSeq Center & Cancer Type (Primary Tumor)", y = "Average AUROC", title = "Correlating AUROC and read depth\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_read_depth_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedReadDepth %>%
  ...
  theme_bw() + theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  geom_text_repel() +
  labs(x = "Average Unmapped Reads Per\nSeq Center & Cancer Type (Primary Tumor)", y = "Average AUPR", title = "Correlating AUPR and unmapped reads\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/aupr_vs_unmapped_reads_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ptRawDataPerfSummarizedReadDepth %>%
  ...
  geom_text_repel() +
  theme_bw()+ theme(aspect.ratio=1, plot.title = element_text(hjust=0.5)) + coord_fixed() +
  labs(x = "Average Unmapped Reads Per\nSeq Center & Cancer Type (Primary Tumor)", y = "Average AUROC", title = "Correlating AUROC and unmapped reads\nfor primary tumor TCGA models (Raw data)") +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_vs_unmapped_reads_all_TCGA_PT_raw_data_AllSeqCenters.svg",
         dpi = "retina", units = "in", width = 7, height = 7)
...
ggarrange(avgROCPlot, avgPRPlot, ncol = 2) +
  ggsave(filename = "Figures/Supplementary_Figures/auroc_aupr_raw_data_wgs_vs_rna.svg",
...
mlPerfAll10k_Allcancer_TopX_VSNM <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_vsnm_topX_ALL_17Nov21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_Allcancer_TopX_VSNM %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX.svg", dpi = "retina",
         width = 9, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_VSNM %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_vs_NAT_TopX.svg", dpi = "retina",
       width = 8, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_VSNM %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_TopX.svg", dpi = "retina",
       width = 8, height = 4, units = "in")
...
# 0.88533708 0.87444888 0.89622528 0.00552152
...
mlPerfAll10k_Allcancer_TopX_Raw <- read.csv("Interim_data/rep_perfFungi_10k_rep1_tcga_raw_topX_by_seq_center_ALL_DecontamV2_17Nov21.csv", stringsAsFactors = FALSE)
abbreviationsTCGA_Allcancer <- read.csv("Supporting_data/tcga_abbreviations.csv", stringsAsFactors = FALSE, row.names = 1)
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX_Raw_HMS.svg", dpi = "retina",
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX_Raw_BCM.svg", dpi = "retina",
       width = 7, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX_Raw_MDA.svg", dpi = "retina",
       width = 7, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX_Raw_WashU.svg", dpi = "retina",
       width = 7, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX_Raw_UNC.svg", dpi = "retina",
       width = 9, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PT_TopX_Raw_CMS.svg", dpi = "retina",
       width = 7, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PTvsNAT_TopX_Raw_HMS.svg", dpi = "retina",
       width = 6, height = 4, units = "in")
# BCM
mlPerfAll10k_Allcancer_TopX_Raw %>%
  filter(sampleType == "Primary Tumor vs Solid Tissue Normal") %>%
  ...
  ggtitle("BCM | Raw Data | Top 20 fungi from Hopkins cohort\nPrimary Tumor vs Solid Tissue Normal") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PTvsNAT_TopX_Raw_BCM.svg", dpi = "retina",
       width = 6, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  ggtitle("UNC | Raw Data | Top 20 fungi from Hopkins cohort\nPrimary Tumor vs Solid Tissue Normal") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PTvsNAT_TopX_Raw_UNC.svg", dpi = "retina",
       width = 7, height = 4, units = "in")
...
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_PTvsNAT_TopX_Raw_CMS.svg", dpi = "retina",
       width = 5, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_TopX_Raw_HMS.svg", dpi = "retina",
       width = 6, height = 4, units = "in")
# BCM
mlPerfAll10k_Allcancer_TopX_Raw %>%
  filter(sampleType == "Blood Derived Normal") %>%
  ...
  ggtitle("BCM | Raw Data | Top 20 fungi from Hopkins cohort\nBlood Derived Normal | 1 Vs All") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_TopX_Raw_BCM.svg", dpi = "retina",
       width = 6, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  ggtitle("MDA | Raw Data | Top 20 fungi from Hopkins cohort\nBlood Derived Normal | 1 Vs All") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_TopX_Raw_MDA.svg", dpi = "retina",
       width = 6, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  ggtitle("WashU | Raw Data | Top 20 fungi from Hopkins cohort\nBlood Derived Normal | 1 Vs All") + theme(plot.title = element_text(hjust = 0.5)) +
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_TopX_Raw_WashU.svg", dpi = "retina",
       width = 6, height = 4, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  rotate_x_text(90) + scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed")
ggsave("Figures/Supplementary_Figures/mlPerfAll10k_rep1_Allcancers_BDN_TopX_Raw_AllSeqCenters.svg", dpi = "retina",
       width = 10, height = 5, units = "in")
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  pull(AUROC) %>% ci()
# Estimate   CI lower   CI upper Std. Error 
# 0.73381447 0.71411246 0.75351648 0.01001525
...
mlPerfAll10k_Allcancer_TopX_Raw %>%
  ...
  pull(AUROC) %>% ci()
# Estimate    CI lower    CI upper  Std. Error 
# 0.723819644 0.713496911 0.734142378 0.005256975 
