...
in_dir=/projects/tcga-data/mycobiome_coverage_analysis/extracted_sam_files_fungi_all_qiita_samples
...
python ${zebra_dir}/calculate_coverages.py \
 -i ${in_dir}/ \
 -o ${out_dir}/fungi_filt_updated_29Sep21_coverage_all_wgs_and_rna_output.tsv \
