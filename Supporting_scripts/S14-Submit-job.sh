...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/ML_mycobiome_tcga_by_seq_center_taxa_levels
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S14-ML-fungi-10k-rep1-tcga-by-seqcenter-taxa-levels-and-WIS-intersect.R
