#!/bin/bash
#SBATCH --job-name=mlFungiWGS   # Job name
...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/ML_mycobiome_tcga_wgs
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S06-ML-fungi-10k-rep1-tcga-wgs.R
