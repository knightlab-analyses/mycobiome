#-----------------------------------------------------------------------------
# S16-ML-fungi-10k-rep1-tcga-scrambled-and-shuffled-controls.R
...
metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2_HMS_scrambled,
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_scrambled_and_shuffled_controls_DecontamV2_26Oct21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_scrambled_and_shuffled_controls_ALL_DecontamV2_26Oct21"
