#-----------------------------------------------------------------------------
# S09-ML-fungi-10k-rep1-tcga-shared-features.R
...
## Import data
load("data_for_ml_tcga_shared_features_15Sep21.RData")
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_shared_features_15Sep21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_shared_features_ALL_15Sep21"
