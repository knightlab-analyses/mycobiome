...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/ML_mycobiome_tcga_shared_features
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S09B-ML-fungi-10k-rep1-tcga-shared-features.R
