#!/bin/bash
#SBATCH --job-name=mlPTFungiVsBact   # Job name
...
#SBATCH --output=/home/gdpoore/cluster/logs/mlPTFungiVsBact_%j.log    # Standard output and error log
...
Rscript S27-ML-fungi-vs-bacteria-number-features-per-cancer-type-ranked-PT.R
