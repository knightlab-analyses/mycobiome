...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/ML_mycobiome_tcga
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S04B-ML-fungi-10k-rep1-higher-taxa-tcga.R
