#-----------------------------------------------------------------------------
# S35-ML-fungi-10k-rep1-tcga-full-wgs-rna-vsnm-STonly-VSNM-decontamV2.R
...
## Import data
load("data_for_ml_tcga_wgs_vs_rna_sample_type_VSNM_decontamV2_27Nov21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiDecontamV2SpeciesVSNM,
     rep200FungiDecontamV2SpeciesVSNM_WGS,
     rep200FungiDecontamV2SpeciesVSNM_RNA)

datasetListNames <- c("rep200FungiDecontamV2SpeciesVSNM",
     "rep200FungiDecontamV2SpeciesVSNM_WGS",
     "rep200FungiDecontamV2SpeciesVSNM_RNA")
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_full_wgs_rna_vsnm_STonly_DecontamV2_27Nov21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_full_wgs_rna_vsnm_STonly_ALL_DecontamV2_27Nov21"
