...
## Import data
load("data_for_ml_tcga_by_seq_center_and_experimental_strategy_taxa_levels_and_wz_intersect_decontamV2_14Oct21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(df_psRep200_HiSeq_Fungi_DecontamV2_HMS_phylum,
...
datasetListNames <- c("df_psRep200_HiSeq_Fungi_DecontamV2_HMS_phylum",
     "df_psRep200_HiSeq_Fungi_DecontamV2_HMS_class",
     "df_psRep200_HiSeq_Fungi_DecontamV2_HMS_order",
     "df_psRep200_HiSeq_Fungi_DecontamV2_HMS_family",
     "df_psRep200_HiSeq_Fungi_DecontamV2_HMS_genus",
...
metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2_HMS",
     "metaQiitaCombined_Nonzero_DecontamV2_HMS",
     "metaQiitaCombined_Nonzero_DecontamV2_HMS",
     "metaQiitaCombined_Nonzero_DecontamV2_HMS",
     "metaQiitaCombined_Nonzero_DecontamV2_HMS",
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_by_seq_center_taxa_level_and_WIS_intersect_decontamV2_14Oct21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_by_seq_center_taxa_level_and_WIS_intersect_ALL_decontamV2_14Oct21"
