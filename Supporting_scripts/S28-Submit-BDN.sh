#!/bin/bash
#SBATCH --job-name=mlRankingBDN   # Job name
...
#SBATCH --output=/home/gdpoore/cluster/logs/mlRankingBDN_%j.log    # Standard output and error log
...
Rscript S28-calculate-ranked-features-fungi-with-bacteria-BDN.R
