...
## Import data
load("data_for_ml_8_cancers_shared_features_decontamV2_14Oct21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiPhylumShared_8cancer_Nonzero_VSNM,
...
datasetListNames <- c("rep200FungiPhylumShared_8cancer_Nonzero_VSNM",
                    "rep200FungiFamilyShared_8cancer_Nonzero_VSNM",
                    "rep200FungiGenusShared_8cancer_Nonzero_VSNM",
                    "rep200FungiSpeciesShared_8cancer_Nonzero_VSNM")

metadataList <- list(metaQiitaCombined_Nonzero_8cancer_PhylumShared,
...
metadataListNames <- list("metaQiitaCombined_Nonzero_8cancer_PhylumShared",
                    "metaQiitaCombined_Nonzero_8cancer_FamilyShared",
                    "metaQiitaCombined_Nonzero_8cancer_GenusShared",
                    "metaQiitaCombined_Nonzero_8cancer_SpeciesShared")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_8cancers_shared_features_decontamV2_14Oct21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_8cancers_shared_features_ALL_decontamV2_14Oct21"
