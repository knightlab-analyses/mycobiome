...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(snmDataOGUFungi_WGS)

# MODIFY AS NEEDED
datasetListNames <- c("snmDataOGUFungi_WGS")

# MATCHED METADATA DATA FRAME FOR ALL COUNT DATA:
metaTmpQC <- metaQiitaCombined_Nonzero_WGS # MODIFY AS NEEDED
metaTmpPath <- metaQiitaCombined_Nonzero_WGS # MODIFY AS NEEDED / PATHOLOGY METADATA DATA FRAME
...
for(jj in seq_along(datasetList)){
  ...
  write.csv(perfTmp2[[jj]], file = paste0("perfFungi_10k_rep1_tcga_wgs_13Sep21_",datasetName,".csv"))
  write.csv(rep_perfTmp2[[jj]], file = paste0("rep_perfFungi_10k_rep1_tcga_wgs_13Sep21_",datasetName,".csv"))
}
...
write.csv(perf1VsAll, file = paste0("perfFungi_10k_rep1_tcga_wgs_ALL_13Sep21.csv"))
write.csv(rep_perf1VsAll, file = paste0("rep_perfFungi_10k_rep1_tcga_wgs_ALL_13Sep21.csv"))
