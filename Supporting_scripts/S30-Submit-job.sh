...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/ML_BDN_early_VSNM
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S30-ML-fungi-tcga-VSNM-BDN-early-stage.R
