...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AA_Resubmission/ml_tcga_seq_center_with_cov_filter
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S03R-ML-fungi-10k-rep1-tcga-by-seqcenter.R
