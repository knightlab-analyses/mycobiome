...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/ML_mycobiome_tcga_8cancers_wgs_vs_rna
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S13-ML-fungi-10k-rep1-tcga-8cancers-wgs-vs-rna-all-taxa-levels.R
