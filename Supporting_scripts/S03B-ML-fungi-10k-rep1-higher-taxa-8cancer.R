#-----------------------------------------------------------------------------
# S03B-ML-fungi-10k-rep1-higher-taxa-8cancer.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Run machine learning on 8 cancer types matching Weizmann data
#-----------------------------------------------------------------------------
...
## Import data
load("data_for_ml_8_cancers_decontamV2_14Oct21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiDecontamV2Order_8cancer_VSNM,
...
# MODIFY AS NEEDED
datasetListNames <- c("rep200FungiDecontamV2Order_8cancer_VSNM",
     "rep200FungiDecontamV2Family_8cancer_VSNM",
     "rep200FungiDecontamV2Genus_8cancer_VSNM",
     "rep200FungiDecontamV2Species_8cancer_VSNM",
     "rep200FungiDecontamV2Genus_8cancer_VSNM_CT",
...
metaTmpQC <- metaQiitaCombined_Nonzero_DecontamV2_8cancer # MODIFY AS NEEDED
metaTmpPath <- metaQiitaCombined_Nonzero_DecontamV2_8cancer # MODIFY AS NEEDED / PATHOLOGY METADATA DATA FRAME
...
for(jj in seq_along(datasetList)){
  ...
  write.csv(perfTmp2[[jj]], file = paste0("perfFungi_10k_rep1_8cancer_decontamV2_14Oct21_",datasetName,".csv"))
  write.csv(rep_perfTmp2[[jj]], file = paste0("rep_perfFungi_10k_rep1_8cancer_decontamV2_14Oct21_",datasetName,".csv"))
}
...
write.csv(perf1VsAll, file = paste0("perfFungi_10k_rep1_8cancer_higher_taxa_and_intersected_ALL_decontamV2_14Oct21.csv"))
write.csv(rep_perf1VsAll, file = paste0("rep_perfFungi_10k_rep1_8cancer_higher_taxa_and_intersected_ALL_decontamV2_14Oct21.csv"))
