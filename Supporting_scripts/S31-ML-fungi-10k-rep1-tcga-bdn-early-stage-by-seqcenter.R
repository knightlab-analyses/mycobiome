#-----------------------------------------------------------------------------
# S31-ML-fungi-10k-rep1-tcga-bdn-early-stage-by-seqcenter.R
...
## Import data
load("data_for_ml_raw_counts_bdn_stageI_II_17Nov21.RData")
...
# MODIFY AS NEEDED
datasetList <- list(rep200_HiSeq_Fungi_DecontamV2_Path_BDN_HMS,
...
datasetListNames <- c("rep200_HiSeq_Fungi_DecontamV2_Path_BDN_HMS",
     "rep200_HiSeq_Fungi_DecontamV2_Path_BDN_BCM",
     "rep200_HiSeq_Fungi_DecontamV2_Path_BDN_MDA",
     "rep200_HiSeq_Fungi_DecontamV2_Path_BDN_WashU",
     "rep200_HiSeq_Fungi_DecontamV2_Path_BDN_Broad_WGS")

metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2_Path_BDN_HMS,
...
metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2_Path_BDN_HMS",
     "metaQiitaCombined_Nonzero_DecontamV2_Path_BDN_BCM",
     "metaQiitaCombined_Nonzero_DecontamV2_Path_BDN_MDA",
     "metaQiitaCombined_Nonzero_DecontamV2_Path_BDN_WashU",
     "metaQiitaCombined_Nonzero_DecontamV2_Path_BDN_Broad_WGS")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_bdn_early_stage_by_seq_center_DecontamV2_17Nov21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_bdn_early_stage_by_seq_center_ALL_DecontamV2_17Nov21"
