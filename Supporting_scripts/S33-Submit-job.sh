...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/ML_TopX_Raw
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S33-ML-fungi-10k-rep1-tcga-raw-topX-by-seqcenter.R
