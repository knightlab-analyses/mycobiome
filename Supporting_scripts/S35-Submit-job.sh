...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/ML_mycobiome_tcga_full_wgs_rna_vsnm_STonly
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S35-ML-fungi-10k-rep1-tcga-full-wgs-rna-vsnm-STonly-VSNM-decontamV2.R
