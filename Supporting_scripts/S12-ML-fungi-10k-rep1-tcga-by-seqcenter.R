...
## Import data
load("data_for_ml_tcga_by_seq_center_and_experimental_strategy_with_coverage_filter_02Oct21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200_HiSeq_Fungi_Decontam_HMS,
...
datasetListNames <- c("rep200_HiSeq_Fungi_Decontam_HMS",
     "rep200_HiSeq_Fungi_Decontam_BCM",
     "rep200_HiSeq_Fungi_Decontam_MDA",
     "rep200_HiSeq_Fungi_Decontam_WashU",
     "rep200_HiSeq_Fungi_Decontam_Broad_WGS",
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_by_seq_center_02Oct21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_by_seq_center_ALL_02Oct21"
