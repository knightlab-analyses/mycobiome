#-----------------------------------------------------------------------------
# S12-ML-fungi-10k-rep1-tcga-by-seqcenter.R
...
## Import data
load("data_for_ml_tcga_by_seq_center_and_experimental_strategy_with_coverage_filter_decontamV2_14Oct21.RData")
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_by_seq_center_DecontamV2_14Oct21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_by_seq_center_ALL_DecontamV2_14Oct21"
