#-----------------------------------------------------------------------------
# S19R-ML-tcga-validation-half-VSNM.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Compare ML on TCGA validation halves using VSNM data
#-----------------------------------------------------------------------------
...
valResSplitsVsHalf_VSNM <- crossTestSplitML(metadataSplit1 = valSplit1Metadata,
                                       ...
                                       sampleTypeList = c("Primary Tumor vs Solid Tissue Normal",
                                                          ...
                                                          "Primary Tumor"),
                                       numKFold = 10, baseName = "vsnm_data_k10")
