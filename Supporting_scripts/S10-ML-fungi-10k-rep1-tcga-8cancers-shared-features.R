...
## Import data
load("data_for_ml_8_cancers_shared_features_15Sep21.RData")
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_8cancers_shared_features_15Sep21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_8cancers_shared_features_ALL_15Sep21"
