#-----------------------------------------------------------------------------
# S30-ML-fungi-tcga-VSNM-BDN-early-stage.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Run machine learning on all available TCGA cancer types using high coverage features
#-----------------------------------------------------------------------------
...
## Import data
load("data_for_ml_vsnm_bdn_stageI_II_17Nov21.RData")
...
# MODIFY AS NEEDED
datasetList <- list(rep200FungiDecontamV2SpeciesVSNM_Path_BDN)

datasetListNames <- c("rep200FungiDecontamV2SpeciesVSNM_Path_BDN")

metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2_Path_BDN)

metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2_Path_BDN")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_vsnm_bdn_early_stage_17Nov21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_vsnm_bdn_early_stage_ALL_17Nov21"
