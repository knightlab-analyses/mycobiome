#!/bin/bash
#SBATCH --job-name=mlFungiVsBact   # Job name
...
#SBATCH --output=/home/gdpoore/cluster/logs/mlFungiVsBact_%j.log    # Standard output and error log
...
Rscript S17B-ML-fungi-vs-bacteria-number-features.R
