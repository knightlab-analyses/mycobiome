...
## Import data
load("data_for_ml_WIS_samples_fungi_bacteria_5Apr22.RData")
...
baseNamePerDatasetResultsFile <- "perfWIS_10k_rep1_fungi_bacteria_5Apr22_"
baseNameAllResultsFile <- "perfWIS_10k_rep1_fungi_bacteria_ALL_5Apr22"
