...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AA_Resubmission/ml_mycobiome_tcga_8cancers_wgs_vs_rna
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S09R-ML-fungi-10k-rep1-tcga-8cancers-wgs-vs-rna-all-taxa-levels.R
