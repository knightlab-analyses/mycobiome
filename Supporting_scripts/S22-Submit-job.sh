...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/ML_high_coverage_8cancers
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S22-ML-fungi-tcga-8cancers-high-coverage.R
