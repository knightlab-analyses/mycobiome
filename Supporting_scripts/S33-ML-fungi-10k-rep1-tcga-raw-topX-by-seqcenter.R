#-----------------------------------------------------------------------------
# S33-ML-fungi-10k-rep1-tcga-raw-topX-by-seqcenter.R
...
## Import data
load("data_for_ml_tcga_raw_topX_per_seq_center_17Nov21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200_HiSeq_Fungi_DecontamV2_TopX_HMS,
...
datasetListNames <- c("rep200_HiSeq_Fungi_DecontamV2_TopX_HMS",
     "rep200_HiSeq_Fungi_DecontamV2_TopX_BCM",
     "rep200_HiSeq_Fungi_DecontamV2_TopX_MDA",
     "rep200_HiSeq_Fungi_DecontamV2_TopX_WashU",
     "rep200_HiSeq_Fungi_DecontamV2_TopX_Broad_WGS_Nonzero",
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_raw_topX_by_seq_center_DecontamV2_17Nov21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_raw_topX_by_seq_center_ALL_DecontamV2_17Nov21"
