...
## Import data
load("data_for_ml_tcga_vsnm_topX_17Nov21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiDecontamV2SpeciesVSNM_TopX)

datasetListNames <- c("rep200FungiDecontamV2SpeciesVSNM_TopX")

metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2)

metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_vsnm_topX_17Nov21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_vsnm_topX_ALL_17Nov21"
