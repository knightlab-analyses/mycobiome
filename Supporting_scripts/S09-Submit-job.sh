...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/ML_mycobiome_tcga_shared_features
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S09-ML-fungi-10k-rep1-tcga-shared-features.R
