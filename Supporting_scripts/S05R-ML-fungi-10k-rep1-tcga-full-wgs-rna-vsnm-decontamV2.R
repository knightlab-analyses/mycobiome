#-----------------------------------------------------------------------------
# S06B-ML-fungi-10k-rep1-tcga-full-wgs-rna-vsnm-decontamV2.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Run machine learning on all available TCGA cancer types and compare by data type
#-----------------------------------------------------------------------------
...
## Import data
load("data_for_ml_tcga_wgs_vs_rna_decontamV2_2Apr22.RData")

# GBM HYPERPARAMETER SEARCH GRID BELOW (DEFAULT PER CARET PACKAGE)
hyperparametersDf <- data.frame(.mtry=c(4))
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(snmDataOGUFungiDecontamV2,
     snmDataOGUFungiDecontamV2_WGS,
     snmDataOGUFungiDecontamV2_RNA)

datasetListNames <- c("snmDataOGUFungiDecontamV2",
     "snmDataOGUFungiDecontamV2_WGS",
     "snmDataOGUFungiDecontamV2_RNA")

metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2,
     metaQiitaCombined_Nonzero_DecontamV2_WGS,
     metaQiitaCombined_Nonzero_DecontamV2_RNA)

metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2",
     "metaQiitaCombined_Nonzero_DecontamV2_WGS",
     "metaQiitaCombined_Nonzero_DecontamV2_RNA")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_full_wgs_rna_vsnm_DecontamV2_14Oct21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_full_wgs_rna_vsnm_ALL_DecontamV2_14Oct21"
