#-----------------------------------------------------------------------------
# S09B-ML-fungi-10k-rep1-tcga-shared-features.R
...
## Import data
load("data_for_ml_tcga_shared_features_decontamV2_14Oct21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiFamilyShared_NonzeroVSNM,
                    rep200FungiGenusShared_NonzeroVSNM,
                    rep200FungiSpeciesShared_NonzeroVSNM)

metadataList <- list(metaQiitaCombined_Nonzero_FamilyShared,
                    metaQiitaCombined_Nonzero_GenusShared,
                    metaQiitaCombined_Nonzero_SpeciesShared)

# MODIFY AS NEEDED
datasetListNames <- c("rep200FungiFamilyShared_NonzeroVSNM",
                    "rep200FungiGenusShared_NonzeroVSNM",
                    "rep200FungiSpeciesShared_NonzeroVSNM")

metadataListNames <- list("metaQiitaCombined_Nonzero_FamilyShared",
                    "metaQiitaCombined_Nonzero_GenusShared",
                    "metaQiitaCombined_Nonzero_SpeciesShared")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_shared_features_decontamV2_14Oct21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_shared_features_ALL_decontamV2_14Oct21"
