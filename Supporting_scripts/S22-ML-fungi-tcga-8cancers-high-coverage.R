#-----------------------------------------------------------------------------
# S22-ML-fungi-tcga-8cancers-high-coverage.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Run machine learning on TCGA-WIS intersecting cancer types using high coverage features
#-----------------------------------------------------------------------------
...
## Import data
load("data_for_ml_tcga_8cancers_high_coverage_03Nov21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiSpecies_8cancer_Cov_Nonzero_VSNM)

datasetListNames <- c("rep200FungiSpecies_8cancer_Cov_Nonzero_VSNM")

metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2_8cancer_Cov_Nonzero_Filt)

metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2_8cancer_Cov_Nonzero_Filt")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_8cancers_high_coverage_03Nov21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_8cancers_high_coverage_ALL_decontamV2_03Nov21"
