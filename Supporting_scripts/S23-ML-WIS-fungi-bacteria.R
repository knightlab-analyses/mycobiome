#-----------------------------------------------------------------------------
# S23-ML-WIS-fungi-bacteria.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Run machine learning on Weizmann data between and within cancer types
#-----------------------------------------------------------------------------
...
## Import data
load("data_for_ml_WIS_samples_fungi_bacteria_04Nov21.RData")
...
sampleTypeList <- c("tumor vs normal",
                    "tumor",
                    "tumor vs nat")
# MODIFY AS NEEDED
datasetList <- list(wzFungiFreeCountsFilt,
...
datasetListNames <- c("wzFungiFreeCountsFilt",
     "ra_wzFungiFreeCountsFilt",
     "binary_wzFungiFreeCountsFilt",
     "count_binary_wzFungiFreeCountsFilt",
...
metadataList <- list(metaWzFungiBacteriaCombinedFreeFilt,
  metaWzFungiBacteriaCombinedFreeFilt,
  metaWzFungiBacteriaCombinedFreeFilt,
  metaWzFungiBacteriaCombinedFreeFilt,
  metaWzFungiBacteriaCombinedFreeFilt,
  metaWzFungiBacteriaCombinedFreeFilt,
...
metadataListNames <- list("metaWzFungiBacteriaCombinedFreeFilt",
  "metaWzFungiBacteriaCombinedFreeFilt",
  "metaWzFungiBacteriaCombinedFreeFilt",
  "metaWzFungiBacteriaCombinedFreeFilt",
  "metaWzFungiBacteriaCombinedFreeFilt",
...
baseNamePerDatasetResultsFile <- "perfWIS_10k_rep1_fungi_bacteria_04Nov21_"
baseNameAllResultsFile <- "perfWIS_10k_rep1_fungi_bacteria_ALL_04Nov21"
