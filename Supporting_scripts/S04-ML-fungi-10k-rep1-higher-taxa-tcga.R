...
## Import data
load("data_for_ml_tcga_13Sep21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiOrderVSNM,
...
# MODIFY AS NEEDED
datasetListNames <- c("rep200FungiOrderVSNM",
     "rep200FungiFamilyVSNM",
     "rep200FungiGenusVSNM",
     "rep200FungiSpeciesVSNM",
     "rep200FungiGenusVSNM_CT",
...
metaTmpQC <- metaQiitaCombined_Nonzero # MODIFY AS NEEDED
metaTmpPath <- metaQiitaCombined_Nonzero # MODIFY AS NEEDED / PATHOLOGY METADATA DATA FRAME
...
for(jj in seq_along(datasetList)){
  ...
  write.csv(perfTmp2[[jj]], file = paste0("perfFungi_10k_rep1_tcga_13Sep21_",datasetName,".csv"))
  write.csv(rep_perfTmp2[[jj]], file = paste0("rep_perfFungi_10k_rep1_tcga_13Sep21_",datasetName,".csv"))
}
...
write.csv(perf1VsAll, file = paste0("perfFungi_10k_rep1_tcga_higher_taxa_and_intersected_ALL_13Sep21.csv"))
write.csv(rep_perf1VsAll, file = paste0("rep_perfFungi_10k_rep1_tcga_higher_taxa_and_intersected_ALL_13Sep21.csv"))
