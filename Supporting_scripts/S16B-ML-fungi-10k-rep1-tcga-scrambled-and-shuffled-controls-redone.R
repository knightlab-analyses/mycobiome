#-----------------------------------------------------------------------------
# S16B-ML-fungi-10k-rep1-tcga-scrambled-and-shuffled-controls-redone.R
# Copyright (c) 2021--, Greg Poore
# Purpose: Run control machine learning analyses using scrambled metadata and shuffled data
#-----------------------------------------------------------------------------
...
## Import data
load("shuffled_controls_VSNM_data_TCGA_26Oct21.RData")
load("shuffled_controls_raw_data_TCGA_26Oct21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
# First: Normal data with scrambled metadata
# Second: Shuffled data with normal metadata
datasetList <- list(rep200_HiSeq_Fungi_DecontamV2_HMS,
...
datasetListNames <- c("rep200_HiSeq_Fungi_DecontamV2_HMS",
     "rep200_HiSeq_Fungi_DecontamV2_BCM",
     "rep200_HiSeq_Fungi_DecontamV2_MDA",
     "rep200_HiSeq_Fungi_DecontamV2_WashU",
     "rep200_HiSeq_Fungi_DecontamV2_Broad_WGS",
...
metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2_HMS,
...
metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2_HMS_scrambled",
  ...
  "metaQiitaCombined_Nonzero_DecontamV2_HMS_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_BCM_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_MDA_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_WashU_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_Broad_WGS_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_UNC_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_CMS_shuffled",
     "metaQiitaCombined_Nonzero_DecontamV2_Broad_RNA_shuffled",

     "metaQiitaCombined_Nonzero_DecontamV2_scrambled",
     "metaQiitaCombined_Nonzero_DecontamV2_shuffled")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_scrambled_and_shuffled_controls_DecontamV2_17Nov21"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_scrambled_and_shuffled_controls_ALL_DecontamV2_17Nov21"
