...
## Import data
load("data_for_ml_weizmann_15Sep21.RData")
...
# MODIFY AS NEEDED
datasetList <- list(ra_weizmannPhylum, binary_weizmannPhylum, weizmannPhylum,
  ra_weizmannClass, binary_weizmannClass, weizmannClass,
  ra_weizmannOrder, binary_weizmannOrder, weizmannOrder,
  ra_weizmannFamily, binary_weizmannFamily, weizmannFamily,
  ra_weizmannGenus, binary_weizmannGenus, weizmannGenus,
  ra_weizmannSpecies, binary_weizmannSpecies, weizmannSpecies,

  ra_weizmannPhylumShared_Nonzero, binary_weizmannPhylumShared_Nonzero, weizmannPhylumShared_Nonzero,
  ra_weizmannClassShared_Nonzero, binary_weizmannClassShared_Nonzero, weizmannClassShared_Nonzero,
  ra_weizmannOrderShared_Nonzero, binary_weizmannOrderShared_Nonzero, weizmannOrderShared_Nonzero,
  ra_weizmannFamilyShared_Nonzero, binary_weizmannFamilyShared_Nonzero, weizmannFamilyShared_Nonzero,
  ra_weizmannGenusShared_Nonzero, binary_weizmannGenusShared_Nonzero, weizmannGenusShared_Nonzero,
  ra_weizmannSpeciesShared_Nonzero, binary_weizmannSpeciesShared_Nonzero, weizmannSpeciesShared_Nonzero)

datasetListNames <- c("ra_weizmannPhylum", "binary_weizmannPhylum", "weizmannPhylum",
  "ra_weizmannClass", "binary_weizmannClass", "weizmannClass",
  "ra_weizmannOrder", "binary_weizmannOrder", "weizmannOrder",
  "ra_weizmannFamily", "binary_weizmannFamily", "weizmannFamily",
  "ra_weizmannGenus", "binary_weizmannGenus", "weizmannGenus",
...
metadataList <- list(weizmannMetaPhylum, weizmannMetaPhylum, weizmannMetaPhylum,
  weizmannMetaClass, weizmannMetaClass, weizmannMetaClass,
  weizmannMetaOrder, weizmannMetaOrder, weizmannMetaOrder,
  weizmannMetaFamily, weizmannMetaFamily, weizmannMetaFamily,
  weizmannMetaGenus, weizmannMetaGenus, weizmannMetaGenus,
  weizmannMetaSpecies, weizmannMetaSpecies, weizmannMetaSpecies,

  weizmannMetaPhylumShared_Nonzero, weizmannMetaPhylumShared_Nonzero, weizmannMetaPhylumShared_Nonzero,
  weizmannMetaClassShared_Nonzero, weizmannMetaClassShared_Nonzero, weizmannMetaClassShared_Nonzero,
  weizmannMetaOrderShared_Nonzero, weizmannMetaOrderShared_Nonzero, weizmannMetaOrderShared_Nonzero,
  weizmannMetaFamilyShared_Nonzero, weizmannMetaFamilyShared_Nonzero, weizmannMetaFamilyShared_Nonzero,
  weizmannMetaGenusShared_Nonzero, weizmannMetaGenusShared_Nonzero, weizmannMetaGenusShared_Nonzero,
  weizmannMetaSpeciesShared_Nonzero, weizmannMetaSpeciesShared_Nonzero, weizmannMetaSpeciesShared_Nonzero)

metadataListNames <- list("weizmannMetaPhylum", "weizmannMetaPhylum", "weizmannMetaPhylum",
  "weizmannMetaClass", "weizmannMetaClass", "weizmannMetaClass",
  "weizmannMetaOrder", "weizmannMetaOrder", "weizmannMetaOrder",
  "weizmannMetaFamily", "weizmannMetaFamily", "weizmannMetaFamily",
  "weizmannMetaGenus", "weizmannMetaGenus", "weizmannMetaGenus",
...
baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_weizmann_with_and_without_shared_feat_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_weizmann_with_and_without_shared_feat_ALL"
...
for(jj in seq_along(datasetList)){
  ...
  for(kk in seq_along(sampleTypeList)){
    ...
    for(ii in seq_along(levels(metaTmp2$tissue))){
      ...
      print(sprintf("%s | %s | %s", dt, datasetName, metadataName))
      # print(metadataName)
      # print(dt)
