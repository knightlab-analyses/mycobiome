...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AA_Resubmission/ml_mycobiome_tcga_full_wgs_rna_vsnm
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S05R-ML-fungi-10k-rep1-tcga-full-wgs-rna-vsnm-decontamV2.R
