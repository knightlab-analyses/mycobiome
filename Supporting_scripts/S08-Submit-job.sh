...
work_dir=/home/gdpoore/projects/atlas_cancer_microbiome/AAA_Final_Analyses/AAA_DecontamV2/PVCA_mycobiome_taxa_levels
cd ${work_dir}

source activate tcgaAnalysisPythonR

Rscript S08B-Run-pvca-all-taxa-levels.R
