#-----------------------------------------------------------------------------
# S21-ML-fungi-tcga-high-coverage.R
...
## Import data
load("data_for_ml_tcga_high_coverage_03Nov21.RData")
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiCovSpeciesVSNM)

datasetListNames <- c("rep200FungiCovSpeciesVSNM")

metadataList <- list(metaQiitaCombined_Nonzero_DecontamV2_Cov_Nonzero_Filt)

metadataListNames <- list("metaQiitaCombined_Nonzero_DecontamV2_Cov_Nonzero_Filt")

baseNamePerDatasetResultsFile <- "perfFungi_10k_rep1_tcga_high_coverage_14Oct21_"
baseNameAllResultsFile <- "perfFungi_10k_rep1_tcga_high_coverage_ALL_decontamV2_14Oct21"
