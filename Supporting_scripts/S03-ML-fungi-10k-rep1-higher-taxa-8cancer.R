#-----------------------------------------------------------------------------
# S03-ML-fungi-10k-rep1-higher-taxa-8cancer.R
...
sampleTypeList <- c("Primary Tumor vs Solid Tissue Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(rep200FungiOrder_8cancer_VSNM,
...
# MODIFY AS NEEDED
datasetListNames <- c("rep200FungiOrder_8cancer_VSNM",
     "rep200FungiFamily_8cancer_VSNM",
     "rep200FungiGenus_8cancer_VSNM",
     "rep200FungiSpecies_8cancer_VSNM",
     "rep200FungiFamily_8cancer_VSNM_CT",
...
metaTmpQC <- metaQiitaCombined_Nonzero_8cancer # MODIFY AS NEEDED
metaTmpPath <- metaQiitaCombined_Nonzero_8cancer # MODIFY AS NEEDED / PATHOLOGY METADATA DATA FRAME
...
for(jj in seq_along(datasetList)){
  ...
  write.csv(perfTmp2[[jj]], file = paste0("perfFungi_10k_rep1_8cancer_13Sep21_",datasetName,".csv"))
  write.csv(rep_perfTmp2[[jj]], file = paste0("rep_perfFungi_10k_rep1_8cancer_13Sep21_",datasetName,".csv"))
}
...
write.csv(perf1VsAll, file = paste0("perfFungi_10k_rep1_8cancer_higher_taxa_and_intersected_ALL_13Sep21.csv"))
write.csv(rep_perf1VsAll, file = paste0("rep_perfFungi_10k_rep1_8cancer_higher_taxa_and_intersected_ALL_13Sep21.csv"))
