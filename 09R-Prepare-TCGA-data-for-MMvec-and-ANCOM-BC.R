#-----------------------------------------------------------------------------
# 09R-Prepare-TCGA-data-for-MMvec-and-ANCOM-BC.R
...
load("Interim_data/tcga_data_taxa_levels_features_shared_with_Weizmann_29Mar22.RData", verbose = T)
...
metaImmunePT %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/species_intersected_with_WIS_metadata_immune_all_primary_tumors.txt", 
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_bacteria_all_primary_tumors.biom")
rep200Data_Matched2ImmunePT_Fungi_species_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_species))
write_biom(rep200Data_Matched2ImmunePT_Fungi_species_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_fungi_all_primary_tumors.biom")
mycobiomeImmuneCellsMergedPT_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT))
write_biom(mycobiomeImmuneCellsMergedPT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_cibersort_rel_abund_all_TCGA_primary_tumors.biom")
...
metaImmunePT_WGS_HMS %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/species_intersected_with_WIS_metadata_immune_WGS_Harvard_Primary_Tumor.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_HMS_PT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_bacteria_TCGA_Harvard_WGS_Primary_Tumor.biom")
rep200Data_Matched2ImmunePT_Fungi_species_HMS_PT_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_species_HMS_PT))
write_biom(rep200Data_Matched2ImmunePT_Fungi_species_HMS_PT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_fungi_TCGA_Harvard_WGS_Primary_Tumor.biom")
mycobiomeImmuneCellsMergedPT_WGS_HMS_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT_WGS_HMS))
write_biom(mycobiomeImmuneCellsMergedPT_WGS_HMS_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_cibersort_rel_abund_TCGA_Harvard_WGS_Primary_Tumor.biom")
...
metaImmunePT_RNA_UNC %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/species_intersected_with_WIS_metadata_immune_RNA_UNC_Primary_Tumor.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_UNC_PT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_bacteria_TCGA_UNC_RNA_Primary_Tumor.biom")
rep200Data_Matched2ImmunePT_Fungi_species_UNC_PT_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_species_UNC_PT))
write_biom(rep200Data_Matched2ImmunePT_Fungi_species_UNC_PT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_fungi_TCGA_UNC_RNA_Primary_Tumor.biom")
mycobiomeImmuneCellsMergedPT_RNA_UNC_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT_RNA_UNC))
write_biom(mycobiomeImmuneCellsMergedPT_RNA_UNC_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_cibersort_rel_abund_TCGA_UNC_RNA_Primary_Tumor.biom")
...
metaImmunePT_WGS %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/species_intersected_with_WIS_metadata_immune_WGS_AllSeqCenters_Primary_Tumor.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_WGS_PT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_bacteria_TCGA_AllSeqCenters_WGS_Primary_Tumor.biom")
rep200Data_Matched2ImmunePT_Fungi_species_WGS_PT_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_species_WGS_PT))
write_biom(rep200Data_Matched2ImmunePT_Fungi_species_WGS_PT_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_rep200_counts_fungi_TCGA_AllSeqCenters_WGS_Primary_Tumor.biom")
mycobiomeImmuneCellsMergedPT_WGS_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT_WGS))
write_biom(mycobiomeImmuneCellsMergedPT_WGS_BIOM, biom_file = "Interim_data/species_intersected_with_WIS_immune_cibersort_rel_abund_TCGA_AllSeqCenters_WGS_Primary_Tumor.biom")
...
dfSharedSave %>% write.csv("Figures_data/Supplementary_Figures/mmvec_shared_genera_fungi_bacteria_2Apr22.csv", row.names = FALSE)
...
metaImmunePT_genus %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/genus_intersected_with_WIS_metadata_immune_all_primary_tumors.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_Filt_genus_shared_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_bacteria_all_primary_tumors.biom")
rep200Data_Matched2ImmunePT_Fungi_genus_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_genus))
write_biom(rep200Data_Matched2ImmunePT_Fungi_genus_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_fungi_all_primary_tumors.biom")
mycobiomeImmuneCellsMergedPT_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT))
write_biom(mycobiomeImmuneCellsMergedPT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_cibersort_rel_abund_all_TCGA_primary_tumors.biom")
...
metaImmunePT_genus_WGS_HMS %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/genus_intersected_with_WIS_metadata_immune_WGS_Harvard_Primary_Tumor.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_Filt_genus_shared_HMS_PT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_bacteria_TCGA_Harvard_WGS_Primary_Tumor.biom")
rep200Data_Matched2ImmunePT_Fungi_genus_HMS_PT_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_genus_HMS_PT))
write_biom(rep200Data_Matched2ImmunePT_Fungi_genus_HMS_PT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_fungi_TCGA_Harvard_WGS_Primary_Tumor.biom")
mycobiomeImmuneCellsMergedPT_WGS_HMS_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT_WGS_HMS))
write_biom(mycobiomeImmuneCellsMergedPT_WGS_HMS_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_cibersort_rel_abund_TCGA_Harvard_WGS_Primary_Tumor.biom")
...
metaImmunePT_genus_RNA_UNC %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/genus_intersected_with_WIS_metadata_immune_RNA_UNC_Primary_Tumor.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_Filt_genus_shared_UNC_PT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_bacteria_TCGA_UNC_RNA_Primary_Tumor.biom")
rep200Data_Matched2ImmunePT_Fungi_genus_UNC_PT_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_genus_UNC_PT))
write_biom(rep200Data_Matched2ImmunePT_Fungi_genus_UNC_PT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_fungi_TCGA_UNC_RNA_Primary_Tumor.biom")
mycobiomeImmuneCellsMergedPT_RNA_UNC_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT_RNA_UNC))
write_biom(mycobiomeImmuneCellsMergedPT_RNA_UNC_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_cibersort_rel_abund_TCGA_UNC_RNA_Primary_Tumor.biom")
...
metaImmunePT_genus_WGS %>% rownames_to_column("sampleid") %>%
  write.table(file = "Interim_data/genus_intersected_with_WIS_metadata_immune_WGS_AllSeqCenters_Primary_Tumor.txt", 
              quote = FALSE, sep = "\t",row.names = FALSE, col.names = TRUE)
...
write_biom(rep200Data_Matched2ImmunePT_Bacteria_Filt_genus_shared_WGS_PT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_bacteria_TCGA_AllSeqCenters_WGS_Primary_Tumor.biom")
rep200Data_Matched2ImmunePT_Fungi_genus_WGS_PT_BIOM <- make_biom(t(rep200Data_Matched2ImmunePT_Fungi_genus_WGS_PT))
write_biom(rep200Data_Matched2ImmunePT_Fungi_genus_WGS_PT_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_rep200_counts_fungi_TCGA_AllSeqCenters_WGS_Primary_Tumor.biom")
mycobiomeImmuneCellsMergedPT_WGS_BIOM <- make_biom(t(mycobiomeImmuneCellsMergedPT_WGS))
write_biom(mycobiomeImmuneCellsMergedPT_WGS_BIOM, biom_file = "Interim_data/genus_intersected_with_WIS_immune_cibersort_rel_abund_TCGA_AllSeqCenters_WGS_Primary_Tumor.biom")
...
mycobiomeThorssonTableS1MergedPT_WGS %>%
  ...
  write.csv("Interim_data/thorsson_et_al_2018_tableS1_other_metadata_2Apr22.csv", row.names = FALSE)
...
load("Interim_data/decontamResultsV2_25Mar22.RData", verbose = T)
...
runAncomBC_1VsAll_Fungi(countData=rep200Data_WGS_RNA_HiSeq_Fungi_DecontamV2_Nonzero_PT,
                        ...
                        qvalCutoff = 0.05, showTopX = 3, decontamResV2 = decontamResultsV2,
                        ancombcLibCut = 1000,
                        fileString = "tmp_decontamV2_fungi_ancombc_PT_1vsAll_",
                        taxaPlotLabel = "genus")
...
load("Interim_data/shared_bacterial_features_at_each_taxa_level_29Mar22.RData", verbose = T)
