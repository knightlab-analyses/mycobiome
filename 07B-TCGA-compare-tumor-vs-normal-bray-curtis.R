#-----------------------------------------------------------------------------
# 07B-TCGA-compare-tumor-vs-normal-bray-curtis.R
...
load("Interim_data/raw_data_tcga_8_cancers_decontamV2_14Oct21.RData", verbose = T)
...
load("Interim_data/data_for_ml_8_cancers_decontamV2_14Oct21.RData", verbose = T)
...
load("Interim_data/raw_data_tcga_all_cancers_decontamV2_14Oct21.RData", verbose = T)
...
load("Interim_data/data_for_ml_tcga_decontamV2_14Oct21.RData", verbose = T)

load("Interim_data/snmDataFungi_DecontamV2_13Oct21.RData", verbose = T)
...
all(rownames(rep200FungiDecontamV2Species_8cancer_VSNM) == rownames(metaQiitaCombined_Nonzero_DecontamV2_8cancer)) # TRUE
...
ggsave("Figures/Figure_4/tcga_2D_bray_curtis_species_vsnm_scaled.svg",
...
write.csv(bcPlot_SpeciesVSNM$countDataRAfilt,
          file = "Interim_data/t_vs_nat_scaled_rel_abundances_TCGA.csv",
          row.names = TRUE)
write.csv(bcPlot_SpeciesVSNM$metaDataFilt,
          file = "Interim_data/t_vs_nat_scaled_metadata_TCGA.csv",
          row.names = TRUE)
