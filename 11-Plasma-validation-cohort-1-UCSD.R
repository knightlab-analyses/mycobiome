...
# NEW CODE DECONTAMINATING USING DECONTAM V2 APPROACH:
...
sum(contamSumTotalWithTCGA)/sum(colSums(as.matrix(ucsd_rep200Data_decontam_dedup_fungi_nonzero))) #--> 0.03783045

# # OLD CODE DECONTAMINATING USING TCGA V1:
...
# Sanity check
all(rownames(metaUCSDJoined_Fungi_Nonzero) == rownames(ucsd_rep200Data_Filt_Fungi_Nonzero_Decontam))
...
ggsave("Figures/Figure_5/ucsd_all_cancer_vs_healthy_full_WIS_fungi_TopX_15Nov21.svg", 
         dpi = "retina", width = 6, height = 3, units = "in")
ucsdCancerVsHealthyResults %>% write.csv("Figures_data/Figure_5/ucsd_all_cancer_vs_healthy_full_WIS_fungi_15Nov21.csv")
...
ggsave(filename = "Figures/Figure_5/log_ratio_ucsd_f1_f2.svg", dpi = "retina",
...
ggsave(filename = "Figures/Figure_5/log_ratio_ucsd_f1_f3.svg", dpi = "retina",
       units = "in", width = 4, height = 4)
...
ggsave(filename = "Figures/Figure_5/log_ratio_ucsd_f2_f3.svg", dpi = "retina",
       units = "in", width = 4, height = 4)
...
ggsave(filename = "Figures/Figure_5/log_ratio_ucsd_f1_f2_cancer_vs_healthy.svg", dpi = "retina",
       units = "in", width = 4, height = 4)
...
ggsave(filename = "Figures/Figure_5/log_ratio_ucsd_f1_f3_cancer_vs_healthy.svg", dpi = "retina",
       units = "in", width = 4, height = 4)
...
ggsave(filename = "Figures/Figure_5/log_ratio_ucsd_f2_f3_cancer_vs_healthy.svg", dpi = "retina",
       units = "in", width = 4, height = 4)
...
rocCombinedAll <- rocCombined +
  geom_ribbon(data = plots_ucsd_topX_CV$interpROCYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "#ca2c92", alpha = 0.3, inherit.aes = F) +
  geom_path(data = plots_ucsd_topX_CV$interpROCYDf_CI, aes(x = xval, y = Estimate), color = "#A20056FF", size = 0.5) +
  annotate("segment", x = 0.15, xend = 0.25, y = 0.15, yend = 0.15, color = "#A20056FF") +
  annotate("text", x = 0.27, y = 0.15, color = "#A20056FF", label = paste0("UCSD: AUROC 99% CI: [", 
...
prCombinedAll <- prCombined +
  geom_ribbon(data = plots_ucsd_topX_CV$interpPRYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "#ca2c92", alpha = 0.3, inherit.aes = F) +
  geom_path(data = plots_ucsd_topX_CV$interpPRYDf_CI, aes(x = xval, y = Estimate), color = "#A20056FF", size = 0.5) +
  annotate("segment", x = 0.05, xend = 0.15, y = 0.15, yend = 0.15, color = "#A20056FF") +
  annotate("text", x = 0.17, y = 0.15, color = "#A20056FF", label = paste0("UCSD: AUPR 99% CI: [", 
...
ggsave(filename = "Figures/Figure_5/roc_pr_CV_overlay_hopkins_ucsd_topX_fungi.svg",
       units = "in", width = 10, height = 5)

#-------------------WIS-overlapping fungi+bacteria between Hopkins and UCSD-------------------#

ucsdFungiBacteriaWIS_CV <- ml1VsAllUCSD(metaData = metaUCSDJoined_Fungi_Nonzero_SpeciesShared,
                               snmData = cbind(snmData_ucsdRep200FungiSpeciesShared,
                                               snmData_ucsdRep200BacteriaSpeciesShared[rownames(snmData_ucsdRep200FungiSpeciesShared),]),
                               col2Predict = "HvsC",
                               numResampleIter = 10,
                               dataString = "fungi_and_bacteria_intersected_with_Weizmann",
                               varImpFlag = TRUE)
ucsdBacteriaWIS_CV <- ml1VsAllUCSD(metaData = metaUCSDJoined_Fungi_Nonzero_SpeciesShared,
                                        snmData = snmData_ucsdRep200BacteriaSpeciesShared[rownames(snmData_ucsdRep200FungiSpeciesShared),],
                                        col2Predict = "HvsC",
                                        numResampleIter = 10,
                                        dataString = "bacteria_intersected_with_Weizmann",
                                        varImpFlag = TRUE)
ucsdFungiWIS_CV <- ml1VsAllUCSD(metaData = metaUCSDJoined_Fungi_Nonzero_SpeciesShared,
                                   snmData = snmData_ucsdRep200FungiSpeciesShared,
                                   col2Predict = "HvsC",
                                   numResampleIter = 10,
                                   dataString = "fungi_intersected_with_Weizmann",
...
# Load mlFungiBacteriaWISIntersect_CV object
load("Interim_data/hopkins_mlFungiBacteriaWISIntersect_CV_15Nov21.RData")

plots_hopkins_FungiBacteriaWIS_CV <- plotMLWithCIs(mlFungiBacteriaWISIntersect_CV, 
                                       sizeAvgCurve=0.5, 
                                       showRepCurves=TRUE, 
                                       ciAlpha = 0.4, 
                                       sizeRepCurves = 0.25,
                                       colorAvgCurve = "#BB0021FF",
                                       ciFillColor = "firebrick1",
                                       ciLevel = 0.99,
                                       positiveClass="Cancer", 
                                       negativeClass="Healthy")
plots_ucsd_FungiBacteriaWIS_CV <- plotMLWithCIs(ucsdFungiBacteriaWIS_CV,
                                    sizeAvgCurve=0.5, 
                                    showRepCurves=TRUE, 
                                    ciAlpha = 0.4, 
                                    sizeRepCurves = 0.25,
                                    colorAvgCurve = "darkorange2",
                                    ciFillColor = "orange",
                                    ciLevel = 0.99,
                                    positiveClass="Cancer", 
                                    negativeClass="Control")
plots_ucsd_BacteriaWIS_CV <- plotMLWithCIs(ucsdBacteriaWIS_CV,
                                            sizeAvgCurve=0.5, 
                                            showRepCurves=TRUE, 
                                            ciAlpha = 0.4, 
                                            sizeRepCurves = 0.25,
                                            ...
                                            positiveClass="Cancer", 
                                            negativeClass="Control")
plots_ucsd_FungiWIS_CV <- plotMLWithCIs(ucsdFungiWIS_CV,
                                        sizeAvgCurve=0.5, 
                                        showRepCurves=TRUE, 
                                        ciAlpha = 0.4, 
                                        sizeRepCurves = 0.25,
                                        colorAvgCurve = "purple",
                                        ciFillColor = "purple",
                                        ciLevel = 0.99,
                                        positiveClass="Cancer", 
                                        negativeClass="Control")

synergyUCSDWISDf <- data.frame(AUROC = c(plots_ucsd_FungiWIS_CV$auroc,
                                     plots_ucsd_BacteriaWIS_CV$auroc,
                                     plots_ucsd_FungiBacteriaWIS_CV$auroc),
                           AUPR = c(plots_ucsd_FungiWIS_CV$aupr,
                                    plots_ucsd_BacteriaWIS_CV$aupr,
                                    plots_ucsd_FungiBacteriaWIS_CV$aupr),
...
synergyUCSDWISDf %>%
  ...
  adjust_pvalue() %>%
  add_significance() %>%
  add_xy_position(group = "Dataset") %>%
  data.frame()

# Combine ROC curves
rocCombined <- plots_ucsd_FungiBacteriaWIS_CV$rocPlot
for(ii in 1:10){
  rocCombined <- rocCombined + 
    geom_path(data = plots_hopkins_FungiBacteriaWIS_CV$rocCurveData[[ii]],aes(x=fpr,y=tpr), color = "lightgray", size = 0.25)
}
rocCombinedAll <- rocCombined +
  geom_ribbon(data = plots_hopkins_FungiBacteriaWIS_CV$interpROCYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "firebrick1", alpha = 0.3, inherit.aes = F) +
  geom_path(data = plots_hopkins_FungiBacteriaWIS_CV$interpROCYDf_CI, aes(x = xval, y = Estimate), color = "#BB0021FF", size = 0.5) +
  annotate("segment", x = 0.05, xend = 0.15, y = 0.15, yend = 0.15, color = "darkorange2") +
  annotate("text", x = 0.17, y = 0.15, color = "darkorange2", label = paste0("UCSD: AUROC 99% CI: [", 
                                                                           paste0(100*round(plots_ucsd_FungiBacteriaWIS_CV$aurocCI[2],4),
                                                                                  ", ",100*round(plots_ucsd_FungiBacteriaWIS_CV$aurocCI[3],4)),"]"), hjust = 0) +
  annotate("segment", x = 0.05, xend = 0.15, y = 0.10, yend = 0.10, color = "#BB0021FF") +
  annotate("text", x = 0.17, y = 0.10, color = "#BB0021FF", label = paste0("Hopkins: AUROC 99% CI: [", 
                                                                           paste0(100*round(plots_hopkins_FungiBacteriaWIS_CV$aurocCI[2],4),
                                                                                  ", ",100*round(plots_hopkins_FungiBacteriaWIS_CV$aurocCI[3],4)),"]"), hjust = 0)

# Combine PR curves
prCombined <- plots_ucsd_FungiBacteriaWIS_CV$prPlot
for(ii in 1:10){
  prCombined <- prCombined + 
    geom_path(data = plots_hopkins_FungiBacteriaWIS_CV$prCurveData[[ii]],aes(x=recall,y=precision), color = "lightgray", size = 0.25)
}
prCombinedAll <- prCombined +
  geom_ribbon(data = plots_hopkins_FungiBacteriaWIS_CV$interpPRYDf_CI, aes(x = xval, ymin = CI.lower, ymax = CI.upper), 
              fill = "firebrick1", alpha = 0.3, inherit.aes = F) +
  geom_path(data = plots_hopkins_FungiBacteriaWIS_CV$interpPRYDf_CI, aes(x = xval, y = Estimate), color = "#BB0021FF", size = 0.5) +
  annotate("segment", x = 0.05, xend = 0.15, y = 0.15, yend = 0.15, color = "darkorange2") +
  annotate("text", x = 0.17, y = 0.15, color = "darkorange2", label = paste0("UCSD: AUPR 99% CI: [", 
                                                                           paste0(100*round(plots_ucsd_FungiBacteriaWIS_CV$auprCI[2],4),
                                                                                  ", ",100*round(plots_ucsd_FungiBacteriaWIS_CV$auprCI[3],4)),"]"), hjust = 0) +
  annotate("segment", x = 0.05, xend = 0.15, y = 0.1, yend = 0.1, color = "#BB0021FF") +
  annotate("text", x = 0.17, y = 0.10, color = "#BB0021FF", label = paste0("Hopkins: AUPR 99% CI: [", 
                                                                           paste0(100*round(plots_hopkins_FungiBacteriaWIS_CV$auprCI[2],4),
                                                                                  ", ",100*round(plots_hopkins_FungiBacteriaWIS_CV$auprCI[3],4)),"]"), hjust = 0)
combinedPlotTitle <- paste0("WIS-overlapping fungi+bacteria in Hopkins and UCSD plasma cohorts\nHopkins: 287 species | UCSD: 281 species\nCancer vs Healthy (10-fold CV repeated 10 times)")
combinedOverlayPlots <- ggarrange(rocCombinedAll, prCombinedAll, ncol = 2)
combinedOverlayPlotsAnnotated <- annotate_figure(combinedOverlayPlots, 
                                                 top = text_grob(combinedPlotTitle, 
                                                                 color = "black", face = "bold", size = 14))
print(combinedOverlayPlotsAnnotated)
ggsave(filename = "Figures/Figure_5/roc_pr_CV_overlay_hopkins_ucsd_FungiBacteriaWIS_fungi.svg",
       units = "in", width = 10, height = 5)
...
ucsdPerCancerVsHealthyResults %>%
  ...
  rotate_x_text(0) + scale_color_nejm(name = "Dataset") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Figure_5/ucsd_per_cancer_type_vs_healthy_full_WIS_fungi_topX_15Nov21.svg", 
       dpi = "retina", width = 7, height = 4, units = "in")
ucsdPerCancerVsHealthyResults %>% write.csv("Figures_data/Figure_5/ucsd_per_cancer_type_vs_healthy_full_WIS_fungi_15Nov21.csv")
...
ucsd1VsAllResults %>%
  ...
  theme(plot.title = element_text(hjust = 0.5)) + scale_y_continuous(breaks = seq(0, 1, by = 0.1), limits = c(0,1)) +
  rotate_x_text(0) + scale_color_nejm(name = "Dataset") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Figure_5/ucsd_between_cancer_types_full_WIS_fungi_15Nov21.svg", 
       dpi = "retina", width = 7, height = 4, units = "in")
ucsd1VsAllResults %>% write.csv("Figures_data/Figure_5/ucsd_between_cancer_types_full_WIS_fungi_15Nov21.csv")
...
ggsave("Figures/Figure_5/ucsd_per_taxa_level_bacteria_and_fungi_13Nov21.svg", 
       dpi = "retina", width = 8, height = 4, units = "in")
ucsdTaxaLevel_results %>% write.csv("Figures_data/Supplementary_Figures/ucsd_per_taxa_level_bacteria_and_fungi_13Nov21.csv")
...
ucsdTaxaLevel_results %>%
  ...
  # rotate_x_text(90) + 
  scale_color_nejm(name = "Features") + geom_hline(yintercept = 1, linetype="dashed") 
ggsave("Figures/Figure_5/ucsd_per_taxa_level_fungi_decontam_13Nov21.svg", 
...
ggsave(filename = paste0("Figures/Figure_5/controls_ucsd_auroc_aupr.svg"),
...
mlIOR(snmData = snmDataIOR, dzType = "SKCM")

## Full data (not run)
# loocvIOR_Full_NSCLC <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_IOR_Filt,
#                           snmData = snmDataUCSD_FullRep200_OGU_IOR, 
#                           dzType = "NSCLC")
# 
# loocvIOR_Full_SKCM <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_IOR_Filt,
#                           snmData = snmDataUCSD_FullRep200_OGU_IOR, 
#                           dzType = "SKCM")
# AUROC: 0.49 | AUPR: 0.75
save(loocvIOR_Full_SKCM, file = "Interim_data/ucsd_loocvIOR_Full_SKCM_16Nov21.RData")
## WIS-overlapping fungi+bacteria
loocvIOR_WIS_FungiBacteria_NSCLC <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_SpeciesShared_IOR_Filt,
                                snmData = ucsdWIS_VSNM_FungiBacteria_IOR_Filt, 
                                dzType = "NSCLC")
# AUROC: 0.12 | AUPR: 0.18
loocvIOR_WIS_FungiBacteria_SKCM <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_SpeciesShared_IOR_Filt,
                               snmData = snmData_ucsdRep200FungiSpeciesShared_IOR, 
                               dzType = "SKCM",
                               savePlotFlag = TRUE,
                               dataStringForPlotFilename = "WIS_Shared_Fungi_and_Bacteria")
# AUROC: 0.71 | AUPR: 0.71
## Fungi decontaminated
loocvIOR_FungiDecontam_NSCLC <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_IOR_Filt,
                                snmData = snmDataUCSD_Fungi_Decontam_OGU_IOR, 
                                dzType = "NSCLC")
# AUROC: 0.49 | AUPR: 0.40
loocvIOR_FungiDecontam_SKCM <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_IOR_Filt,
                               snmData = snmDataUCSD_Fungi_Decontam_OGU_IOR, 
                               dzType = "SKCM",
                               savePlotFlag = TRUE,
                               dataStringForPlotFilename = "Fungi_Decontam")
# AUROC: 0.6 | AUPR: 0.65
...
# AUROC: 0.71 | AUPR: 0.71
loocvIOR_BacteriaShared_SKCM <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_IOR_Filt,
                                      snmData = snmData_ucsdRep200BacteriaSpeciesShared_IOR, 
                                      dzType = "SKCM")
# AUROC: 0.38 | AUPR: 0.62
loocvIOR_Fungi_TopX_SKCM <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_TopX_Nonzero_IOR_Filt,
                                     snmData = snmDataUCSD_Fungi_TopX_IOR, 
                                     dzType = "SKCM",
                                     savePlotFlag = TRUE,
                                     dataStringForPlotFilename = "TopX_Fungi")
# AUROC: 0.67 | AUPR: 0.79
loocvIOR_Bacteria_Genus_SKCM <- loocvIOR(metaData = metaUCSDJoined_Fungi_Nonzero_IOR_Filt,
                                     snmData = snmData_ucsdRep200BacteriaGenus_IOR, 
                                     dzType = "SKCM",
                                     savePlotFlag = TRUE,
                                     dataStringForPlotFilename = "Bacteria_Genus")
# AUROC: 0.44 | AUPR: 0.69
