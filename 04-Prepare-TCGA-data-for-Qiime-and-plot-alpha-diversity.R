...
metaQiitaCombined_Nonzero_HMS_PT <- metaQiitaCombined_Nonzero_HMS %>%
  filter(sample_type == "Primary Tumor") %>%
  rename("submitted_name" = "sample_name") %>%
  rownames_to_column("sampleid") %>% droplevels()
metaQiitaCombined_Nonzero_BCM_PT <- metaQiitaCombined_Nonzero_BCM %>%
  filter(sample_type == "Primary Tumor") %>%
  rename("submitted_name" = "sample_name") %>%
  rownames_to_column("sampleid") %>% droplevels()
metaQiitaCombined_Nonzero_MDA_PT <- metaQiitaCombined_Nonzero_MDA %>%
  filter(sample_type == "Primary Tumor") %>%
  rename("submitted_name" = "sample_name") %>%
  rownames_to_column("sampleid") %>% droplevels()
metaQiitaCombined_Nonzero_WashU_PT <- metaQiitaCombined_Nonzero_WashU %>%
  filter(sample_type == "Primary Tumor") %>%
  rename("submitted_name" = "sample_name") %>%
  rownames_to_column("sampleid") %>% droplevels()
metaQiitaCombined_Nonzero_Broad_WGS_PT <- metaQiitaCombined_Nonzero_Broad_WGS %>%
  filter(sample_type == "Primary Tumor") %>%
  rename("submitted_name" = "sample_name") %>%
  rownames_to_column("sampleid") %>% droplevels()
...
## Subset count data
rep200_HiSeq_Fungi_Decontam_HMS_PT <- rep200_HiSeq_Fungi_Decontam_HMS[metaQiitaCombined_Nonzero_HMS_PT$sampleid,]
rep200_HiSeq_Fungi_Decontam_BCM_PT <- rep200_HiSeq_Fungi_Decontam_BCM[metaQiitaCombined_Nonzero_BCM_PT$sampleid,]
rep200_HiSeq_Fungi_Decontam_MDA_PT <- rep200_HiSeq_Fungi_Decontam_MDA[metaQiitaCombined_Nonzero_MDA_PT$sampleid,]
rep200_HiSeq_Fungi_Decontam_WashU_PT <- rep200_HiSeq_Fungi_Decontam_WashU[metaQiitaCombined_Nonzero_WashU_PT$sampleid,]
rep200_HiSeq_Fungi_Decontam_Broad_WGS_PT <- rep200_HiSeq_Fungi_Decontam_Broad_WGS[metaQiitaCombined_Nonzero_Broad_WGS_PT$sampleid,]
...
# HMS
alphaDivOtus_HMS <- read.csv("Qiime_data_and_scripts/core_metrics_hms_5k/alpha_div_observed_features_hms_5k.csv", stringsAsFactors = FALSE)
alphaDivShannon_HMS <- read.csv("Qiime_data_and_scripts/core_metrics_hms_5k/alpha_div_shannon_hms_5k.csv", stringsAsFactors = FALSE)
...
# BCM
alphaDivOtus_BCM <- read.csv("Qiime_data_and_scripts/core_metrics_bcm_5k/alpha_div_observed_features_bcm_5k.csv", stringsAsFactors = FALSE)
alphaDivShannon_BCM <- read.csv("Qiime_data_and_scripts/core_metrics_bcm_5k/alpha_div_shannon_bcm_5k.csv", stringsAsFactors = FALSE)
...
# MDA
alphaDivOtus_MDA <- read.csv("Qiime_data_and_scripts/core_metrics_mda_5k/alpha_div_observed_features_mda_5k.csv", stringsAsFactors = FALSE)
alphaDivShannon_MDA <- read.csv("Qiime_data_and_scripts/core_metrics_mda_5k/alpha_div_shannon_mda_5k.csv", stringsAsFactors = FALSE)
...
# WashU
alphaDivOtus_WashU <- read.csv("Qiime_data_and_scripts/core_metrics_washU_5k/alpha_div_observed_features_washU_5k.csv", stringsAsFactors = FALSE)
alphaDivShannon_WashU <- read.csv("Qiime_data_and_scripts/core_metrics_washU_5k/alpha_div_shannon_washU_5k.csv", stringsAsFactors = FALSE)
...
# Broad WGS
alphaDivOtus_Broad_WGS <- read.csv("Qiime_data_and_scripts/core_metrics_broad_WGS_2k/alpha_div_observed_features_broad_WGS_2k.csv", stringsAsFactors = FALSE)
alphaDivShannon_Broad_WGS <- read.csv("Qiime_data_and_scripts/core_metrics_broad_WGS_2k/alpha_div_shannon_broad_WGS_2k.csv", stringsAsFactors = FALSE)
...
alphaDivOtus_HMS_colored %>%
  ...
  stat_n_text() + 
  ggsave(filename = "Figures/Figure_3/figure_3_C_alphaDivOtusPlot_HMS.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivOtus_HMS_colored %>% write.csv("Figures_data/Figure_3/figure_3_C_alphaDivOtusPlot_HMS.csv")
...
alphaDivShannon_HMS_colored %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() + 
  ggsave(filename = "Figures/Figure_3/figure_3_C_alphaDivShannonPlot_HMS.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivShannon_HMS_colored %>% write.csv("Figures_data/Figure_3/figure_3_C_alphaDivOtusPlot_HMS.csv")
...
alphaDivOtus_MDA_colored %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() + 
  ggsave(filename = "Figures/Figure_3/figure_3_C_alphaDivOtusPlot_MDA.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivOtus_MDA_colored %>% write.csv("Figures_data/Figure_3/figure_3_C_alphaDivOtusPlot_MDA.csv")
...
alphaDivShannon_MDA_colored %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() +
  ggsave(filename = "Figures/Figure_3/figure_3_C_alphaDivShannonPlot_MDA.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
alphaDivShannon_MDA_colored %>% write.csv("Figures_data/Figure_3/figure_3_C_alphaDivShannonPlot_MDA.csv")
...
alphaDivOtus_BCM %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() + 
  ggsave(filename = "Figures/Supplementary_Figures/alphaDivOtusPlot_BCM.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivShannon_BCM %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() +
  ggsave(filename = "Figures/Supplementary_Figures/alphaDivShannonPlot_BCM.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivOtus_WashU %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() + 
  ggsave(filename = "Figures/Supplementary_Figures/alphaDivOtusPlot_WashU.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivShannon_WashU %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() +
  ggsave(filename = "Figures/Supplementary_Figures/alphaDivShannonPlot_WashU.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivOtus_Broad_WGS %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() + 
  ggsave(filename = "Figures/Supplementary_Figures/alphaDivOtusPlot_Broad_WGS.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
...
alphaDivShannon_Broad_WGS %>%
  ...
  stat_compare_means(label.x.npc = 0.1, label.y.npc = 0.5) + 
  stat_n_text() +
  ggsave(filename = "Figures/Supplementary_Figures/alphaDivShannonPlot_Broad_WGS.jpeg",
         dpi = "retina", units = "in", height = 4, width = 7)
